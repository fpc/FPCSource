...
unit cp8859_16;
  ...
  const
     map : array[0..255] of tunicodecharmapping = (
       ...
       (unicode : 536; flag : umf_noinfo; reserved: 0),
       ...
       (unicode : 537; flag : umf_noinfo; reserved: 0),
       ...
       (unicode : 538; flag : umf_noinfo; reserved: 0),
       ...
       (unicode : 539; flag : umf_noinfo; reserved: 0),
     ...
     reversemap : array[0..255] of treversecharmapping = (
       ...
       (unicode : 261; char1 : 162; char2 : 0),
       (unicode : 262; char1 : 197; char2 : 0),
       (unicode : 263; char1 : 229; char2 : 0),
       (unicode : 268; char1 : 178; char2 : 0),
       (unicode : 269; char1 : 185; char2 : 0),
       (unicode : 272; char1 : 208; char2 : 0),
       (unicode : 273; char1 : 240; char2 : 0),
       (unicode : 280; char1 : 221; char2 : 0),
       (unicode : 281; char1 : 253; char2 : 0),
       ...
       (unicode : 338; char1 : 188; char2 : 0),
       (unicode : 339; char1 : 189; char2 : 0),
       (unicode : 346; char1 : 215; char2 : 0),
       (unicode : 347; char1 : 247; char2 : 0),
       (unicode : 352; char1 : 166; char2 : 0),
       (unicode : 353; char1 : 168; char2 : 0),
       (unicode : 368; char1 : 216; char2 : 0),
       (unicode : 369; char1 : 248; char2 : 0),
       (unicode : 376; char1 : 190; char2 : 0),
       (unicode : 377; char1 : 172; char2 : 0),
       (unicode : 378; char1 : 174; char2 : 0),
       (unicode : 379; char1 : 175; char2 : 0),
       (unicode : 380; char1 : 191; char2 : 0),
       (unicode : 381; char1 : 180; char2 : 0),
       (unicode : 382; char1 : 184; char2 : 0),
       (unicode : 536; char1 : 170; char2 : 0),
       (unicode : 537; char1 : 186; char2 : 0),
       (unicode : 538; char1 : 222; char2 : 0),
       (unicode : 539; char1 : 254; char2 : 0),
       (unicode : 8221; char1 : 181; char2 : 0),
       (unicode : 8222; char1 : 165; char2 : 0),
