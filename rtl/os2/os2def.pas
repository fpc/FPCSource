...
{ Constants from bseord.h header file (ordinal numbers of API functions) }
    ...
    const
       ...
       Ord_DosPROTECTCLOSE = 622;
       Ord_DosPROTECTFILEIO = 623;
       Ord_DosPROTECTFILELOCKS = 624;
       Ord_DosPROTECTNEWSIZE = 627;
       Ord_DosPROTECTOPEN = 628;
       Ord_DosPROTECTQFHANDSTATE = 629;
       Ord_DosPROTECTSETFHANDSTATE = 630;
       Ord_DosPROTECTQFILEINFO = 631;
       Ord_DosPROTECTSETFILEINFO = 632;
       Ord_DosPROTECTCHGFILEPTR = 634;
       Ord_DosPROTECTENUMATTRIBUTE = 635;
       ...
       Ord_DosFSRAMSEMREQUEST2 = 991;
       Ord_DosFSRAMSEMCLEAR2 = 992;
       Ord_Dos32LISTIO = 996;
