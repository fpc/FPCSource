...
type
  ...
  TCLKCTRL = object //Clock controller
    ...
    Reserved30: byte;
    Reserved31: byte;
    XOSCHFCTRLA: byte;  //XOSC High-Frequency Control A
  const
    // CLKCTRL_CLKSEL
    CLKSELmask = $07;
    CLKSEL_OSCHF = $00;
  ...
  TEVSYS = object //Event System
    ...
    USEREVSYSEVOUTA: byte;  //User 13 - EVOUTA
    USEREVSYSEVOUTB: byte;  //User 14 - EVOUTB
    USEREVSYSEVOUTC: byte;  //User 15 - EVOUTC
    USEREVSYSEVOUTD: byte;  //User 16 - EVOUTD
    USEREVSYSEVOUTE: byte;  //User 17 - EVOUTE
    USEREVSYSEVOUTF: byte;  //User 18 - EVOUTF
    Reserved51: byte;
    USERUSART0IRDA: byte;  //User 20 - USART0
    USERUSART1IRDA: byte;  //User 21 - USART1
    USERUSART2IRDA: byte;  //User 22 - USART2
    USERUSART3IRDA: byte;  //User 23 - USART3
    USERUSART4IRDA: byte;  //User 24 - USART4
    Reserved57: byte;
    USERTCA0CNTA: byte;  //User 26 - TCA0 Event A
    USERTCA0CNTB: byte;  //User 27 - TCA0 Event B
    USERTCA1CNTA: byte;  //User 28 - TCA1 Event A
    USERTCA1CNTB: byte;  //User 29 - TCA1 Event B
    USERTCB0CAPT: byte;  //User 30 - TCB0 Event A
    USERTCB0COUNT: byte;  //User 31 - TCB0 Event B
    USERTCB1CAPT: byte;  //User 32 - TCB1 Event A
    USERTCB1COUNT: byte;  //User 33 - TCB1 Event B
    USERTCB2CAPT: byte;  //User 34 - TCB2 Event A
    USERTCB2COUNT: byte;  //User 35 - TCB2 Event B
    USERTCB3CAPT: byte;  //User 36 - TCB3 Event A
    USERTCB3COUNT: byte;  //User 37 - TCB3 Event B
    Reserved70: byte;
    Reserved71: byte;
    USERTCD0INPUTA: byte;  //User 40 - TCD0 Event A
    USERTCD0INPUTB: byte;  //User 41 - TCD0 Event B
    USEROPAMP0ENABLE: byte;  //User 42 - OPAMP0 Enable
    USEROPAMP0DISABLE: byte;  //User 43 - OPAMP0 Disable
    USEROPAMP0DUMP: byte;  //User 44 - OPAMP0 Dump
    USEROPAMP0DRIVE: byte;  //User 45 - OPAMP0 Drive
    USEROPAMP1ENABLE: byte;  //User 46 - OPAMP1 Enable
    USEROPAMP1DISABLE: byte;  //User 47 - OPAMP1 Disable
    USEROPAMP1DUMP: byte;  //User 48 - OPAMP1 Dump
    USEROPAMP1DRIVE: byte;  //User 49 - OPAMP1 Drive
    USEROPAMP2ENABLE: byte;  //User 50 - OPAMP2 Enable
    USEROPAMP2DISABLE: byte;  //User 51 - OPAMP2 Disable
    USEROPAMP2DUMP: byte;  //User 52 - OPAMP2 Dump
    USEROPAMP2DRIVE: byte;  //User 53 - OPAMP2 Drive
  const
    // EVSYS_SWEVENTA
    SWEVENTAmask = $FF;
    SWEVENTA_CH0 = $01;
    ...
    CHANNEL0_ZCD1 = $31;
    CHANNEL0_ZCD2 = $32;
    CHANNEL0_OPAMP0_READY = $34;
    CHANNEL0_OPAMP1_READY = $35;
    CHANNEL0_OPAMP2_READY = $36;
    ...
    CHANNEL1_ZCD1 = $31;
    CHANNEL1_ZCD2 = $32;
    CHANNEL1_OPAMP0_READY = $34;
    CHANNEL1_OPAMP1_READY = $35;
    CHANNEL1_OPAMP2_READY = $36;
    ...
    CHANNEL2_ZCD1 = $31;
    CHANNEL2_ZCD2 = $32;
    CHANNEL2_OPAMP0_READY = $34;
    CHANNEL2_OPAMP1_READY = $35;
    CHANNEL2_OPAMP2_READY = $36;
    ...
    CHANNEL3_ZCD1 = $31;
    CHANNEL3_ZCD2 = $32;
    CHANNEL3_OPAMP0_READY = $34;
    CHANNEL3_OPAMP1_READY = $35;
    CHANNEL3_OPAMP2_READY = $36;
    ...
    CHANNEL4_ZCD1 = $31;
    CHANNEL4_ZCD2 = $32;
    CHANNEL4_OPAMP0_READY = $34;
    CHANNEL4_OPAMP1_READY = $35;
    CHANNEL4_OPAMP2_READY = $36;
    ...
    CHANNEL5_ZCD1 = $31;
    CHANNEL5_ZCD2 = $32;
    CHANNEL5_OPAMP0_READY = $34;
    CHANNEL5_OPAMP1_READY = $35;
    CHANNEL5_OPAMP2_READY = $36;
    ...
    CHANNEL6_ZCD1 = $31;
    CHANNEL6_ZCD2 = $32;
    CHANNEL6_OPAMP0_READY = $34;
    CHANNEL6_OPAMP1_READY = $35;
    CHANNEL6_OPAMP2_READY = $36;
    ...
    CHANNEL7_ZCD1 = $31;
    CHANNEL7_ZCD2 = $32;
    CHANNEL7_OPAMP0_READY = $34;
    CHANNEL7_OPAMP1_READY = $35;
    CHANNEL7_OPAMP2_READY = $36;
    ...
    CHANNEL8_ZCD1 = $31;
    CHANNEL8_ZCD2 = $32;
    CHANNEL8_OPAMP0_READY = $34;
    CHANNEL8_OPAMP1_READY = $35;
    CHANNEL8_OPAMP2_READY = $36;
    ...
    CHANNEL9_ZCD1 = $31;
    CHANNEL9_ZCD2 = $32;
    CHANNEL9_OPAMP0_READY = $34;
    CHANNEL9_OPAMP1_READY = $35;
    CHANNEL9_OPAMP2_READY = $36;
  ...
  TMVIO = object //Multi-Voltage I/O
    INTCTRL: byte;  //Interrupt Control
    INTFLAGS: byte;  //Interrupt Flags
    STATUS: byte;  //Status
  const
  ...
  TOPAMP = object //Operational Amplifier System
    CTRLA: byte;  //Control A
    DBGCTRL: byte;  //Debug Control
    TIMEBASE: byte;  //Timebase Value
    Reserved3: byte;
    Reserved4: byte;
    Reserved5: byte;
    Reserved6: byte;
    ...
    Reserved13: byte;
    Reserved14: byte;
    PWRCTRL: byte;  //Power Control
    OP0CTRLA: byte;  //Op Amp 0 Control A
    OP0STATUS: byte;  //Op Amp 0 Status
    OP0RESMUX: byte;  //Op Amp 0 Resistor Ladder Multiplexer
    OP0INMUX: byte;  //Op Amp 0 Input Multiplexer
    OP0SETTLE: byte;  //Op Amp 0 Settle
    OP0CAL: byte;  //Op Amp 0 Calibration
    Reserved22: byte;
    Reserved23: byte;
    OP1CTRLA: byte;  //Op Amp 1 Control A
    OP1STATUS: byte;  //Op Amp 1 Status
    OP1RESMUX: byte;  //Op Amp 1 Resistor Ladder Multiplexer
    OP1INMUX: byte;  //Op Amp 1 Input Multiplexer
    OP1SETTLE: byte;  //Op Amp 1 Settle
    OP1CAL: byte;  //Op Amp 1 Calibration
    Reserved30: byte;
    Reserved31: byte;
    OP2CTRLA: byte;  //Op Amp 2 Control A
    OP2STATUS: byte;  //Op Amp 2 Status
    OP2RESMUX: byte;  //Op Amp 2 Resistor Ladder Multiplexer
    OP2INMUX: byte;  //Op Amp 2 Input Multiplexer
    OP2SETTLE: byte;  //Op Amp 2 Settle
    OP2CAL: byte;  //Op Amp 2 Calibration
  const
...
var
  ...
  ZCD2: TZCD absolute $06D0;
  OPAMP: TOPAMP absolute $0700;
...
procedure MVIO_MVIO_ISR; external name 'MVIO_MVIO_ISR'; // Interrupt 4 
procedure RTC_CNT_ISR; external name 'RTC_CNT_ISR'; // Interrupt 5 
procedure RTC_PIT_ISR; external name 'RTC_PIT_ISR'; // Interrupt 6 
procedure CCL_CCL_ISR; external name 'CCL_CCL_ISR'; // Interrupt 7 
procedure PORTA_PORT_ISR; external name 'PORTA_PORT_ISR'; // Interrupt 8 
procedure TCA0_LUNF_ISR; external name 'TCA0_LUNF_ISR'; // Interrupt 9 
//procedure TCA0_OVF_ISR; external name 'TCA0_OVF_ISR'; // Interrupt 9 
procedure TCA0_HUNF_ISR; external name 'TCA0_HUNF_ISR'; // Interrupt 10 
procedure TCA0_CMP0_ISR; external name 'TCA0_CMP0_ISR'; // Interrupt 11 
//procedure TCA0_LCMP0_ISR; external name 'TCA0_LCMP0_ISR'; // Interrupt 11 
procedure TCA0_CMP1_ISR; external name 'TCA0_CMP1_ISR'; // Interrupt 12 
//procedure TCA0_LCMP1_ISR; external name 'TCA0_LCMP1_ISR'; // Interrupt 12 
procedure TCA0_CMP2_ISR; external name 'TCA0_CMP2_ISR'; // Interrupt 13 
//procedure TCA0_LCMP2_ISR; external name 'TCA0_LCMP2_ISR'; // Interrupt 13 
procedure TCB0_INT_ISR; external name 'TCB0_INT_ISR'; // Interrupt 14 
procedure TCB1_INT_ISR; external name 'TCB1_INT_ISR'; // Interrupt 15 
procedure TCD0_OVF_ISR; external name 'TCD0_OVF_ISR'; // Interrupt 16 
procedure TCD0_TRIG_ISR; external name 'TCD0_TRIG_ISR'; // Interrupt 17 
procedure TWI0_TWIS_ISR; external name 'TWI0_TWIS_ISR'; // Interrupt 18 
procedure TWI0_TWIM_ISR; external name 'TWI0_TWIM_ISR'; // Interrupt 19 
procedure SPI0_INT_ISR; external name 'SPI0_INT_ISR'; // Interrupt 20 
procedure USART0_RXC_ISR; external name 'USART0_RXC_ISR'; // Interrupt 21 
procedure USART0_DRE_ISR; external name 'USART0_DRE_ISR'; // Interrupt 22 
procedure USART0_TXC_ISR; external name 'USART0_TXC_ISR'; // Interrupt 23 
procedure PORTD_PORT_ISR; external name 'PORTD_PORT_ISR'; // Interrupt 24 
procedure AC0_AC_ISR; external name 'AC0_AC_ISR'; // Interrupt 25 
procedure ADC0_RESRDY_ISR; external name 'ADC0_RESRDY_ISR'; // Interrupt 26 
procedure ADC0_WCMP_ISR; external name 'ADC0_WCMP_ISR'; // Interrupt 27 
procedure ZCD0_ZCD_ISR; external name 'ZCD0_ZCD_ISR'; // Interrupt 28 
procedure AC1_AC_ISR; external name 'AC1_AC_ISR'; // Interrupt 29 
procedure PORTC_PORT_ISR; external name 'PORTC_PORT_ISR'; // Interrupt 30 
procedure TCB2_INT_ISR; external name 'TCB2_INT_ISR'; // Interrupt 31 
procedure USART1_RXC_ISR; external name 'USART1_RXC_ISR'; // Interrupt 32 
procedure USART1_DRE_ISR; external name 'USART1_DRE_ISR'; // Interrupt 33 
procedure USART1_TXC_ISR; external name 'USART1_TXC_ISR'; // Interrupt 34 
procedure PORTF_PORT_ISR; external name 'PORTF_PORT_ISR'; // Interrupt 35 
procedure NVMCTRL_EE_ISR; external name 'NVMCTRL_EE_ISR'; // Interrupt 36 
procedure SPI1_INT_ISR; external name 'SPI1_INT_ISR'; // Interrupt 37 
procedure USART2_RXC_ISR; external name 'USART2_RXC_ISR'; // Interrupt 38 
procedure USART2_DRE_ISR; external name 'USART2_DRE_ISR'; // Interrupt 39 
procedure USART2_TXC_ISR; external name 'USART2_TXC_ISR'; // Interrupt 40 
procedure AC2_AC_ISR; external name 'AC2_AC_ISR'; // Interrupt 41 
...
procedure TCB3_INT_ISR; external name 'TCB3_INT_ISR'; // Interrupt 44 
procedure PORTB_PORT_ISR; external name 'PORTB_PORT_ISR'; // Interrupt 45 
procedure PORTE_PORT_ISR; external name 'PORTE_PORT_ISR'; // Interrupt 46 
procedure TCA1_LUNF_ISR; external name 'TCA1_LUNF_ISR'; // Interrupt 47 
//procedure TCA1_OVF_ISR; external name 'TCA1_OVF_ISR'; // Interrupt 47 
procedure TCA1_HUNF_ISR; external name 'TCA1_HUNF_ISR'; // Interrupt 48 
procedure TCA1_CMP0_ISR; external name 'TCA1_CMP0_ISR'; // Interrupt 49 
//procedure TCA1_LCMP0_ISR; external name 'TCA1_LCMP0_ISR'; // Interrupt 49 
procedure TCA1_CMP1_ISR; external name 'TCA1_CMP1_ISR'; // Interrupt 50 
//procedure TCA1_LCMP1_ISR; external name 'TCA1_LCMP1_ISR'; // Interrupt 50 
procedure TCA1_CMP2_ISR; external name 'TCA1_CMP2_ISR'; // Interrupt 51 
//procedure TCA1_LCMP2_ISR; external name 'TCA1_LCMP2_ISR'; // Interrupt 51 
procedure ZCD1_ZCD_ISR; external name 'ZCD1_ZCD_ISR'; // Interrupt 52 
procedure USART3_RXC_ISR; external name 'USART3_RXC_ISR'; // Interrupt 53 
procedure USART3_DRE_ISR; external name 'USART3_DRE_ISR'; // Interrupt 54 
procedure USART3_TXC_ISR; external name 'USART3_TXC_ISR'; // Interrupt 55 
procedure USART4_RXC_ISR; external name 'USART4_RXC_ISR'; // Interrupt 56 
procedure USART4_DRE_ISR; external name 'USART4_DRE_ISR'; // Interrupt 57 
procedure USART4_TXC_ISR; external name 'USART4_TXC_ISR'; // Interrupt 58 
procedure ZCD2_ZCD_ISR; external name 'ZCD2_ZCD_ISR'; // Interrupt 60 
...
//  .weak TCA1_LCMP2_ISR
  ...
  .set MVIO_MVIO_ISR, Default_IRQ_handler
...
//  .set TCA1_LCMP2_ISR, Default_IRQ_handler
  ...
  .set ZCD2_ZCD_ISR, Default_IRQ_handler
end;
