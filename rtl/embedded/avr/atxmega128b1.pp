...
procedure PORTE_INT0_ISR; external name 'PORTE_INT0_ISR'; // Interrupt 54 External Interrupt 0
procedure PORTE_INT1_ISR; external name 'PORTE_INT1_ISR'; // Interrupt 55 External Interrupt 1
procedure TCE2_LUNF_ISR; external name 'TCE2_LUNF_ISR'; // Interrupt 58 Low Byte Underflow Interrupt
procedure TCE2_HUNF_ISR; external name 'TCE2_HUNF_ISR'; // Interrupt 59 High Byte Underflow Interrupt
procedure TCE2_LCMPA_ISR; external name 'TCE2_LCMPA_ISR'; // Interrupt 60 Low Byte Compare A Interrupt
procedure TCE2_LCMPB_ISR; external name 'TCE2_LCMPB_ISR'; // Interrupt 61 Low Byte Compare B Interrupt
procedure TCE2_LCMPC_ISR; external name 'TCE2_LCMPC_ISR'; // Interrupt 62 Low Byte Compare C Interrupt
procedure TCE2_LCMPD_ISR; external name 'TCE2_LCMPD_ISR'; // Interrupt 63 Low Byte Compare D Interrupt
procedure USARTE0_RXC_ISR; external name 'USARTE0_RXC_ISR'; // Interrupt 69 Reception Complete Interrupt
procedure USARTE0_DRE_ISR; external name 'USARTE0_DRE_ISR'; // Interrupt 70 Data Register Empty Interrupt
procedure USARTE0_TXC_ISR; external name 'USARTE0_TXC_ISR'; // Interrupt 71 Transmission Complete Interrupt
procedure PORTA_INT0_ISR; external name 'PORTA_INT0_ISR'; // Interrupt 75 External Interrupt 0
procedure PORTA_INT1_ISR; external name 'PORTA_INT1_ISR'; // Interrupt 76 External Interrupt 1
procedure ACA_AC0_ISR; external name 'ACA_AC0_ISR'; // Interrupt 77 AC0 Interrupt
procedure ACA_AC1_ISR; external name 'ACA_AC1_ISR'; // Interrupt 78 AC1 Interrupt
procedure ACA_ACW_ISR; external name 'ACA_ACW_ISR'; // Interrupt 79 ACW Window Mode Interrupt
procedure ADCA_CH0_ISR; external name 'ADCA_CH0_ISR'; // Interrupt 80 Interrupt 0
