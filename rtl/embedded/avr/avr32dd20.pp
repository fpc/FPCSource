...
type
  ...
  TCLKCTRL = object //Clock controller
    ...
    Reserved30: byte;
    Reserved31: byte;
    XOSCHFCTRLA: byte;  //XOSC HF Control A
  const
    // CLKCTRL_CLKSEL
    CLKSELmask = $07;
    CLKSEL_OSCHF = $00;
...
procedure ZCD3_ZCD_ISR; external name 'ZCD3_ZCD_ISR'; // Interrupt 28 
...
//  .set TCA0_LCMP2_ISR, Default_IRQ_handler
  ...
  .set ZCD3_ZCD_ISR, Default_IRQ_handler
