...
const
  ...
  PRFM1B = 0; // PSC 1 Retrigger and Fault Mode for Part B
  // PFRC1A
  ...
  PRFM1A = 0; // PSC 1 Retrigger and Fault Mode for Part A
  // PCTL1
  PPRE1 = 6; // PSC 1 Prescaler Selects
  ...
  // PSOC1
  PSYNC1_ = 4; // Synchronization Out for ADC Selection
