...
type
  ...
  TEVSYS = object //Event System
    ...
    USERTCB2CAPT: byte;  //TCB2 Event A
    USERTCB2COUNT: byte;  //TCB2 Event B
    USERTCB3CAPT: byte;  //TCB3 Event A
    USERTCB3COUNT: byte;  //TCB3 Event B
  const
    // EVSYS_SWEVENTA
    SWEVENTAmask = $FF;
    SWEVENTA_CH0 = $01;
    ...
    CHANNEL_TCA1_OVF_LUNF = $88;
    CHANNEL_TCA1_HUNF = $89;
    CHANNEL_TCA1_CMP0_LCMP0 = $8C;
    CHANNEL_TCA1_CMP1_LCMP1 = $8D;
    CHANNEL_TCA1_CMP2_LCMP2 = $8E;
    CHANNEL_TCB0_CAPT = $A0;
    CHANNEL_TCB0_OVF = $A1;
    CHANNEL_TCB1_CAPT = $A2;
    CHANNEL_TCB1_OVF = $A3;
    CHANNEL_TCB2_CAPT = $A4;
    CHANNEL_TCB2_OVF = $A5;
    CHANNEL_TCB3_CAPT = $A6;
    CHANNEL_TCB3_OVF = $A7;
    // EVSYS_USER
    USERmask = $FF;
    USER_OFF = $00;
...
procedure PORTA_PORT_ISR; external name 'PORTA_PORT_ISR'; // Interrupt 7 
...
procedure AC0_AC_ISR; external name 'AC0_AC_ISR'; // Interrupt 22 
procedure ADC0_ERROR_ISR; external name 'ADC0_ERROR_ISR'; // Interrupt 23 
procedure ADC0_RESRDY_ISR; external name 'ADC0_RESRDY_ISR'; // Interrupt 24 
procedure ADC0_SAMPRDY_ISR; external name 'ADC0_SAMPRDY_ISR'; // Interrupt 25 
procedure AC1_AC_ISR; external name 'AC1_AC_ISR'; // Interrupt 26 
procedure PORTC_PORT_ISR; external name 'PORTC_PORT_ISR'; // Interrupt 27 
procedure TCB2_INT_ISR; external name 'TCB2_INT_ISR'; // Interrupt 28 
procedure USART1_RXC_ISR; external name 'USART1_RXC_ISR'; // Interrupt 29 
procedure USART1_DRE_ISR; external name 'USART1_DRE_ISR'; // Interrupt 30 
procedure USART1_TXC_ISR; external name 'USART1_TXC_ISR'; // Interrupt 31 
procedure PORTF_PORT_ISR; external name 'PORTF_PORT_ISR'; // Interrupt 32 
procedure NVMCTRL_EEREADY_ISR; external name 'NVMCTRL_EEREADY_ISR'; // Interrupt 33 
//procedure NVMCTRL_FLREADY_ISR; external name 'NVMCTRL_FLREADY_ISR'; // Interrupt 33 
//procedure NVMCTRL_NVMREADY_ISR; external name 'NVMCTRL_NVMREADY_ISR'; // Interrupt 33 
procedure USART2_RXC_ISR; external name 'USART2_RXC_ISR'; // Interrupt 34 
procedure USART2_DRE_ISR; external name 'USART2_DRE_ISR'; // Interrupt 35 
procedure USART2_TXC_ISR; external name 'USART2_TXC_ISR'; // Interrupt 36 
procedure TCB3_INT_ISR; external name 'TCB3_INT_ISR'; // Interrupt 37 
procedure TCA1_LUNF_ISR; external name 'TCA1_LUNF_ISR'; // Interrupt 38 
//procedure TCA1_OVF_ISR; external name 'TCA1_OVF_ISR'; // Interrupt 38 
procedure TCA1_HUNF_ISR; external name 'TCA1_HUNF_ISR'; // Interrupt 39 
procedure TCA1_CMP0_ISR; external name 'TCA1_CMP0_ISR'; // Interrupt 40 
//procedure TCA1_LCMP0_ISR; external name 'TCA1_LCMP0_ISR'; // Interrupt 40 
procedure TCA1_CMP1_ISR; external name 'TCA1_CMP1_ISR'; // Interrupt 41 
//procedure TCA1_LCMP1_ISR; external name 'TCA1_LCMP1_ISR'; // Interrupt 41 
procedure TCA1_CMP2_ISR; external name 'TCA1_CMP2_ISR'; // Interrupt 42 
//procedure TCA1_LCMP2_ISR; external name 'TCA1_LCMP2_ISR'; // Interrupt 42 
procedure PORTE_PORT_ISR; external name 'PORTE_PORT_ISR'; // Interrupt 43 
