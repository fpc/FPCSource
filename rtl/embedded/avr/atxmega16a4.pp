...
procedure HIRESE_OVF_ISR; external name 'HIRESE_OVF_ISR'; // Interrupt 53 Overflow Interrupt
procedure HIRESE_ERR_ISR; external name 'HIRESE_ERR_ISR'; // Interrupt 54 Error Interrupt
procedure HIRESE_CCA_ISR; external name 'HIRESE_CCA_ISR'; // Interrupt 55 Compare or Capture A Interrupt
procedure HIRESE_CCB_ISR; external name 'HIRESE_CCB_ISR'; // Interrupt 56 Compare or Capture B Interrupt
...
asm
  ...
  .set HIRESE_OVF_ISR, Default_IRQ_handler
  .set HIRESE_ERR_ISR, Default_IRQ_handler
  .set HIRESE_CCA_ISR, Default_IRQ_handler
  .set HIRESE_CCB_ISR, Default_IRQ_handler
