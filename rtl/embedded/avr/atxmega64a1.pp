...
type
  ...
  TNVM_PROD_SIGNATURES = object //Production Signatures
    RCOSC2M: byte;  //RCOSC 2MHz Calibration Value
    Reserved1: byte;
    RCOSC32K: byte;  //RCOSC 32kHz Calibration Value
    RCOSC32M: byte;  //RCOSC 32MHz Calibration Value
    Reserved4: byte;
    Reserved5: byte;
    Reserved6: byte;
    Reserved7: byte;
    ...
    DACAOFFCAL: byte;  //DACA Calibration Byte 0
    DACAGAINCAL: byte;  //DACA Calibration Byte 1
    DACBOFFCAL: byte;  //DACB Calibration Byte 0
    DACBGAINCAL: byte;  //DACB Calibration Byte 1
  end;
  ...
  TADC_CH = object //ADC Channel
    ...
    INTCTRL: byte;  //Channel Interrupt Control
  ...
  TDAC = object //Digital-to-Analog Converter
    ...
    TIMCTRL: byte;  //Timing Control
    STATUS: byte;  //Status
    Reserved6: byte;
    Reserved7: byte;
    GAINCAL: byte;  //Gain Calibration
    OFFSETCAL: byte;  //Offset Calibration
    Reserved10: byte;
    Reserved11: byte;
    Reserved12: byte;
    Reserved13: byte;
...
procedure TCC0_OVF_ISR; external name 'TCC0_OVF_ISR'; // Interrupt 14 Overflow Interrupt
procedure TCC0_ERR_ISR; external name 'TCC0_ERR_ISR'; // Interrupt 15 Error Interrupt
procedure TCC0_CCA_ISR; external name 'TCC0_CCA_ISR'; // Interrupt 16 Compare or Capture A Interrupt
procedure TCC0_CCB_ISR; external name 'TCC0_CCB_ISR'; // Interrupt 17 Compare or Capture B Interrupt
procedure TCC0_CCC_ISR; external name 'TCC0_CCC_ISR'; // Interrupt 18 Compare or Capture C Interrupt
procedure TCC0_CCD_ISR; external name 'TCC0_CCD_ISR'; // Interrupt 19 Compare or Capture D Interrupt
...
procedure TCF0_OVF_ISR; external name 'TCF0_OVF_ISR'; // Interrupt 108 Overflow Interrupt
procedure TCF0_ERR_ISR; external name 'TCF0_ERR_ISR'; // Interrupt 109 Error Interrupt
procedure TCF0_CCA_ISR; external name 'TCF0_CCA_ISR'; // Interrupt 110 Compare or Capture A Interrupt
procedure TCF0_CCB_ISR; external name 'TCF0_CCB_ISR'; // Interrupt 111 Compare or Capture B Interrupt
procedure TCF0_CCC_ISR; external name 'TCF0_CCC_ISR'; // Interrupt 112 Compare or Capture C Interrupt
procedure TCF0_CCD_ISR; external name 'TCF0_CCD_ISR'; // Interrupt 113 Compare or Capture D Interrupt
...
asm
  ...
  .set TCC0_OVF_ISR, Default_IRQ_handler
  .set TCC0_ERR_ISR, Default_IRQ_handler
  .set TCC0_CCA_ISR, Default_IRQ_handler
  .set TCC0_CCB_ISR, Default_IRQ_handler
  .set TCC0_CCC_ISR, Default_IRQ_handler
  .set TCC0_CCD_ISR, Default_IRQ_handler
  ...
  .set TCF0_OVF_ISR, Default_IRQ_handler
  .set TCF0_ERR_ISR, Default_IRQ_handler
  .set TCF0_CCA_ISR, Default_IRQ_handler
  .set TCF0_CCB_ISR, Default_IRQ_handler
  .set TCF0_CCC_ISR, Default_IRQ_handler
  .set TCF0_CCD_ISR, Default_IRQ_handler
