...
type
  ...
  TVBAT = object //Battery Backup Module
    CTRL: byte;  //Control Register
    STATUS: byte;  //Status Register
    BACKUP0: byte;  //Backup Register 0
    BACKUP1: byte;  //Backup Register 1
  const
  ...
  TRTC32 = object //32-bit Real-Time Counter
    CTRL: byte;  //Control Register
    SYNCCTRL: byte;  //Synchronization Control/Status Register
    INTCTRL: byte;  //Interrupt Control Register
    INTFLAGS: byte;  //Interrupt Flags
    CNT: dword;  //Count Register
    PER: dword;  //Period Register
    COMP: dword;  //Compare Register
  const
    // RTC enable
    ENABLEbm = $01;
...
procedure RTC32_OVF_ISR; external name 'RTC32_OVF_ISR'; // Interrupt 10 Overflow Interrupt
procedure RTC32_COMP_ISR; external name 'RTC32_COMP_ISR'; // Interrupt 11 Compare Interrupt
...
asm
  ...
  .set RTC32_OVF_ISR, Default_IRQ_handler
  .set RTC32_COMP_ISR, Default_IRQ_handler
