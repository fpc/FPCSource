...
type
  ...
  TEVSYS = object //Event System
    ...
    USEREVSYSEVOUTG: byte;  //User 19 - EVOUTG
    ...
    USERUSART5IRDA: byte;  //User 25 - USART5
    ...
    USERTCB4CAPT: byte;  //User 38 - TCB4 Event A
    USERTCB4COUNT: byte;  //User 39 - TCB4 Event B
...
procedure PORTG_PORT_ISR; external name 'PORTG_PORT_ISR'; // Interrupt 59 
procedure ZCD2_ZCD_ISR; external name 'ZCD2_ZCD_ISR'; // Interrupt 60 
procedure TCB4_INT_ISR; external name 'TCB4_INT_ISR'; // Interrupt 61 
procedure USART5_RXC_ISR; external name 'USART5_RXC_ISR'; // Interrupt 62 
procedure USART5_DRE_ISR; external name 'USART5_DRE_ISR'; // Interrupt 63 
procedure USART5_TXC_ISR; external name 'USART5_TXC_ISR'; // Interrupt 64 
