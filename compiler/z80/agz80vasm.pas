...
{        else
    ...
    procedure TZ80vasm.WriteExternals(asmdata: TAsmData);
      var
        sym : TAsmSymbol;
        i   : longint;
      begin
    ...
    procedure TZ80vasm.WriteTree(p: TAsmList;asmlisttype:TAsmListType);
...
{$endif EXTDEBUG}
    ...
    procedure TZ80vasm.WriteAsmList(asmdata: TAsmData);
      var
        hal: TAsmListType;
      begin
    ...
    function TZ80vasm.MakeCmdLine(asmdata: TAsmData): TCmdStr;
      begin
