...
*****************************************************************************}
  ...
  procedure taarch64typeconvnode.second_int_to_real(ctx:tpassgeneratecodecontext);
    var
      op: tasmop;
    begin
  ...
  procedure taarch64typeconvnode.second_int_to_bool(ctx:tpassgeneratecodecontext);
    var
      resflags: tresflags;
    begin
