...
{$if defined(x86) or defined(mips) or defined(sparc) or defined(arm) or defined(m68k) or defined(spc32)}
...
{$endif defined(x86) or defined(mips) or defined(sparc) or defined(arm) or defined(m68k) or defined(spc32)}
