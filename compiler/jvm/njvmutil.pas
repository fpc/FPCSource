...
interface
  ...
  type
    tjvmnodeutils = class(tnodeutils)
      ...
      procedure InsertResourceTablesTable(AsmData: TAsmData); override;
      procedure InsertResourceInfo(AsmData: TAsmData; ResourcesUsed : boolean); override;
...
implementation
  ...
  procedure tjvmnodeutils.InsertWideInits(AsmData: TAsmData);
    begin
      { not required }
    end;


  procedure tjvmnodeutils.InsertResourceTablesTable(AsmData: TAsmData);
    begin
      { not supported }
    end;


  procedure tjvmnodeutils.InsertResourceInfo(AsmData: TAsmData; ResourcesUsed: boolean);
    begin
      { not supported }
    end;
  ...
  procedure tjvmnodeutils.InsertResStrInits(AsmData: TAsmData);
    begin
      { not supported }
    end;
