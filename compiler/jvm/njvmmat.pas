      ...
      begin
        ...
        if nodetype=divn then
          ...
          begin
            ...
            if (torddef(resultdef).ordtype<>u32bit) then
              ...
              begin
                ...
                if left.location.loc=LOC_CONSTANT then
                  ...
                  begin
                    thlcgjvm(hlcg).a_load_loc_stack(current_asmdata.CurrAsmList,left.resultdef,left.location);
                    thlcgjvm(hlcg).resize_stack_int_val(current_asmdata.CurrAsmList,compiler.deftypes.u32inttype,s64inttype,false);
                  end;
            ...
            if isu32int then
              thlcgjvm(hlcg).resize_stack_int_val(current_asmdata.CurrAsmList,s64inttype,compiler.deftypes.u32inttype,false);
          end;
