...
implementation
    ...
    uses
       ...
       globtype,globals,systemstypes,systems,verbose,comphook,cscript,fmodule,i_zxspectrum,link,
...
constructor TInternalLinkerZXSpectrum.create(acompiler: TCompilerBase);
  begin
    inherited;
