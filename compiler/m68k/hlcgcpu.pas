  ...
  procedure thlcgcpu.g_intf_wrapper(list: TAsmList; procdef: tprocdef; const labelname: string; ioffset: longint);
    ...
    procedure putselfa0tostack(offs: longint);
      ...
      begin
        ...
        reference_reset_base(href,compiler.deftypes.voidpointertype,NR_STACK_POINTER_REG,offs,ctempposinvalid,4,[]);
    ...
    procedure loadvmttoa0;
      ...
      begin
        ...
        reference_reset_base(href, compiler.deftypes.voidpointertype, NR_A0,0,ctempposinvalid,4,[]);
        cg.a_load_ref_reg(list,OS_ADDR,OS_ADDR,href,NR_A0);
      end;
    ...
    procedure op_onmethodaddrviastack(offs: longint);
      ...
      begin
        ...
        reference_reset_base(href,compiler.deftypes.voidpointertype,NR_A0,tobjectdef(procdef.struct).vmtmethodoffset(procdef.extnumber),ctempposinvalid,4,[]);
        ...
        reference_reset_base(href2,compiler.deftypes.voidpointertype,NR_STACK_POINTER_REG,0,ctempposinvalid,4,[]);
        href2.direction:=dir_dec;
        list.concat(taicpu.op_ref_ref(A_MOVE,S_L,href,href2));

        { restore A0 from the stack }
        reference_reset_base(href2,compiler.deftypes.voidpointertype,NR_STACK_POINTER_REG,offs+4,ctempposinvalid,4,[]); { offs+4, because we used dir_dec above }
