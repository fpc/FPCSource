...
procedure tobjcrttiwriter.gen_objc_methods(list: tasmlist; objccls: tobjectdef; out methodslabel: tasmsymbol; classmethods, iscategory: Boolean);
  ...
  begin
    ...
    tcb:=ctai_typedconstbuilder.create(FAsmData,SectFlags[compiler.target.info.system in systems_objc_nfabi],compiler);
    ...
    if iscategory then
      begin
        methodslabel:=FAsmData.DefineAsmSymbol('l_OBJC_$_CATEGORY_'+instclsName[classmethods]+'_METHODS_'+objccls.objextname^+'_$_'+objccls.childof.objextname^,AB_LOCAL,AT_DATA,mdef);
      end
    else
      begin
        methodslabel:=FAsmData.DefineAsmSymbol('l_OBJC_$_'+instclsName[classmethods]+'_METHODS_'+objccls.objextname^,AB_LOCAL,AT_DATA,mdef);
      end;
    list.concatList(
...
procedure tobjcrttiwriter.gen_objc_protocol_list(list: tasmlist; classdef: tobjectdef; zero_terminator: boolean; out protolistsym: TAsmSymbol);
  ...
  begin
    ...
    tcb:=ctai_typedconstbuilder.create(FAsmData,[tcalo_new_section],compiler);
    ...
    for i:=0 to protolist.Count-1 do
      begin
        ...
        tcb.emit_tai(tai_const.Create_sym(protosym),compiler.deftypes.voidpointertype);
      end;
...
procedure tobjcrttiwriter_fragile.gen_objc_ivars(list: TAsmList; objccls: tobjectdef; out ivarslabel: TAsmLabel);
  ...
  begin
    ...
    FAsmData.getlabel(ivarslabel,alt_data);
...
function tobjcrttiwriter_fragile.gen_objc_protocol_ext(list: TAsmList; optinstsym, optclssym: TAsmSymbol): TAsmLabel;
  ...
  begin
    if assigned(optinstsym) or
      ...
      begin
        FAsmData.getlabel(Result,alt_data);
        tcb:=ctai_typedconstbuilder.create(FAsmData,[tcalo_new_section,tcalo_no_dead_strip],compiler);
        tcb.begin_anonymous_record(
        ...
        ConcatSymOrNil(tcb,optclssym,compiler.deftypes.voidpointertype);
        { optional properties (todo) }
        ConcatSymOrNil(tcb,nil,compiler.deftypes.voidpointertype);
        list.concatList(
          tcb.get_final_asmlist(
...
procedure tobjcrttiwriter_fragile.gen_objc_protocol(list:TAsmList; protocol: tobjectdef; out protocollabel: TAsmSymbol);
  ...
  begin
    ...
    FAsmData.getlabel(lbl,alt_data);
    protocollabel:=lbl;
    ...
    ConcatSymOrNil(tcb,protoext,compiler.deftypes.voidpointertype);
    { name }
    ...
    ConcatSymOrNil(tcb,reqinstsym,compiler.deftypes.voidpointertype);
    { class methods, in __cat_cls_meth }
    ConcatSymOrNil(tcb,reqclssym,compiler.deftypes.voidpointertype);
    list.concatList(
      tcb.get_final_asmlist(
...
procedure tobjcrttiwriter_fragile.gen_objc_category_sections(list:TAsmList; objccat: tobjectdef; out catlabel: TAsmSymbol; out catlabeldef: tdef);
  ...
  begin
    ...
    ConcatSymOrNil(tcb,instmthdlist,compiler.deftypes.voidpointertype);
    ...
    catsym:=FAsmData.DefineAsmSymbol(objccat.rtti_mangledname(objcclassrtti),AB_LOCAL,AT_DATA,catdef);
    list.concatList(
      tcb.get_final_asmlist(
        catsym,catdef,
  ...
  begin
    ...
    if assigned(objclss.childof) then
      ...
      begin
        ...
        superStrSym:=nil;
        superStrDef:=compiler.deftypes.voidpointertype;
      end;
    ...
    metasym:=FAsmData.DefineAsmSymbol(objclss.rtti_mangledname(objcmetartti),AB_LOCAL,AT_DATA,metadef);
    list.concatList(
      tcb.get_final_asmlist(
        metasym,metaDef,
    ...
    clssym:=FAsmData.DefineAsmSymbol(objclss.rtti_mangledname(objcclassrtti),AB_LOCAL,AT_DATA,clsDef);
    list.concatList(
      tcb.get_final_asmlist(
        clssym,clsDef,
  ...
  begin
    if (classsyms.count<>0) or
      ...
      begin
        ...
        sym := FAsmData.DefineAsmSymbol(compiler.target._asm.labelprefix+'_OBJC_SYMBOLS_$',AB_LOCAL,AT_DATA,symsdef);
    ...
    if assigned(sym) then
      ...
      tcb.emit_tai(tai_const.Create_nil_dataptr,compiler.deftypes.voidpointertype);
    FAsmData.getlabel(lab,alt_data);
...
procedure tobjcrttiwriter_nonfragile.gen_objc_ivars(list: tasmlist; objccls: tobjectdef; out ivarslabel: tasmlabel);
  ...
  begin
          ...
          if objctryencodetype(vf.vardef,enctype,encerr) then
            begin
              ...
              if not(vf.visibility in [vis_public,vis_protected,vis_strictprotected]) then
                ...
                vis:=AB_GLOBAL;
              vars[vcnt].offssym:=FAsmData.DefineAsmSymbol(prefix+vf.RealName,vis,AT_DATA,compiler.deftypes.ptruinttype);
    ...
    tcb:=ctai_typedconstbuilder.create(FAsmData,[tcalo_is_lab,tcalo_new_section,tcalo_no_dead_strip],compiler);
...
procedure tobjcrttiwriter_nonfragile.gen_objc_protocol(list: tasmlist; protocol: tobjectdef; out protocollabel: tasmsymbol);
  ...
  begin
    ...
    lbl:=FAsmData.DefineAsmSymbol(protocol.rtti_mangledname(objcclassrtti),AB_PRIVATE_EXTERN,AT_DATA,prottype);
    protocollabel:=lbl;

    tcb:=ctai_typedconstbuilder.create(FAsmData,[tcalo_new_section,tcalo_weak],compiler);
    ...
    tcb.emit_ord_const(0,compiler.deftypes.u32inttype);
    { extendedMethodTypes }
    ConcatSymOrNil(tcb,extmethodssym,compiler.deftypes.voidpointertype);
    ...
    listsym:=FAsmData.DefineAsmSymbol(protocol.rtti_mangledname(objcmetartti),AB_PRIVATE_EXTERN,AT_DATA,cpointerdef.getreusable(prottype,compiler));
    tcb:=ctai_typedconstbuilder.create(FAsmData,[tcalo_new_section,tcalo_weak,tcalo_no_dead_strip],compiler);
...
procedure tobjcrttiwriter_nonfragile.gen_objc_category_sections(list:TAsmList; objccat: tobjectdef; out catlabel: TAsmSymbol; out catlabeldef: tdef);
  ...
  begin
    ...
    clssym:=FAsmData.RefAsmSymbol(objccat.childof.rtti_mangledname(objcclassrtti),AT_DATA);
    ...
    tcb.queue_init(compiler.deftypes.voidpointertype);
    tcb.queue_emit_asmsym(catstrsym,catstrdef);
    tcb.emit_tai(Tai_const.Create_sym(clssym),compiler.deftypes.voidpointertype);
    ConcatSymOrNil(tcb,instmthdlist,compiler.deftypes.voidpointertype);
    ConcatSymOrNil(tcb,clsmthdlist,compiler.deftypes.voidpointertype);
    ConcatSymOrNil(tcb,protolistsym,compiler.deftypes.voidpointertype);
    { properties, not yet supported }
    ...
    tcb.emit_tai(Tai_const.Create_nil_dataptr,compiler.deftypes.voidpointertype);
    { size }
    tcb.emit_tai(Tai_const.Create_32bit(64),compiler.deftypes.s32inttype);
    { padding }
    tcb.emit_tai(Tai_const.Create_32bit(0),compiler.deftypes.s32inttype);
    catdef:=tcb.end_anonymous_record;
    catsym:=FAsmData.DefineAsmSymbol(objccat.rtti_mangledname(objcclassrtti),AB_LOCAL,AT_DATA,catdef);
    list.concatList(
      tcb.get_final_asmlist(
...
procedure tobjcrttiwriter_nonfragile.gen_objc_class_ro_part(list: tasmlist; objclss: tobjectdef; protolistsym: TAsmSymbol; out classrolabel: tasmsymbol; metaclass: boolean);
  ...
  begin
    ...
    tcb.queue_init(compiler.deftypes.voidpointertype);
    tcb.queue_emit_asmsym(classStrSym,classStrDef);
    ConcatSymOrNil(tcb,methodssym,compiler.deftypes.voidpointertype);
    ConcatSymOrNil(tcb,protolistsym,compiler.deftypes.voidpointertype);
    ConcatSymOrNil(tcb,ivarslab,compiler.deftypes.voidpointertype);
    { weak ivar layout for garbage collection (deprecated) }
    tcb.emit_tai(tai_const.Create_nil_dataptr,compiler.deftypes.voidpointertype);
    { TODO: properties }
    tcb.emit_tai(tai_const.Create_nil_dataptr,compiler.deftypes.voidpointertype);
    rodef:=tcb.end_anonymous_record;
    rosym:=FAsmData.DefineAsmSymbol(objclss.rtti_mangledname(rttitype),AB_LOCAL,AT_DATA,rodef);
    list.concatList(
      tcb.get_final_asmlist(
        rosym,rodef,
...
procedure tobjcrttiwriter_nonfragile.gen_objc_classes_sections(list:TAsmList; objclss: tobjectdef; out classlabel: TAsmSymbol; out classlabeldef: tdef);
  ...
  begin
    ...
    isatcb:=ctai_typedconstbuilder.create(FAsmData,[],compiler);
    classdef:=isatcb.begin_anonymous_record(
      internaltypeprefixName[itb_objc_nf_class],
      C_alignment,1,
      targetinfos[compiler.target.info.system]^.alignment.recordalignmin);

    metatcb:=ctai_typedconstbuilder.create(FAsmData,[tcalo_new_section],compiler);
    metadef:=metatcb.begin_anonymous_record(
      internaltypeprefixName[itb_objc_nf_meta_class],
      C_alignment,1,
      targetinfos[compiler.target.info.system]^.alignment.recordalignmin);

    clssym:=FAsmData.DefineAsmSymbol(objclss.rtti_mangledname(objcclassrtti),vis,AT_DATA,classdef);
    metasym:=FAsmData.DefineAsmSymbol(objclss.rtti_mangledname(objcmetartti),vis,AT_DATA,metadef);
    { 2) the superclass and meta superclass }
    if assigned(objclss.childof) then
      begin
        superSym:=FAsmData.RefAsmSymbol(objclss.childof.rtti_mangledname(objcclassrtti),AT_DATA);
        superMetaSym:=FAsmData.RefAsmSymbol(objclss.childof.rtti_mangledname(objcmetartti),AT_DATA);
      end
    else
      begin
        superSym:=nil;
    ...
    while assigned(root.childof) do
      root:=root.childof;
    metaisaSym:=FAsmData.RefAsmSymbol(root.rtti_mangledname(objcmetartti),AT_DATA);
    ...
    { the isa }
    metatcb.emit_tai(Tai_const.Create_sym(metaisaSym),compiler.deftypes.voidpointertype);
    { the superclass }
    metatcb.emit_tai(Tai_const.Create_sym(superMetaSym),compiler.deftypes.voidpointertype);
    { pointer to cache }
    if not assigned(ObjCEmptyCacheVar) then
      ObjCEmptyCacheVar:=FAsmData.RefAsmSymbol(compiler.target.info.Cprefix+'_objc_empty_cache',AT_DATA);
    metatcb.emit_tai(Tai_const.Create_sym(ObjCEmptyCacheVar),compiler.deftypes.voidpointertype);
    { pointer to vtable }
    if not assigned(ObjCEmptyVtableVar) and
      ...
      ObjCEmptyVtableVar:=FAsmData.RefAsmSymbol(compiler.target.info.Cprefix+'_objc_empty_vtable',AT_DATA);
    ConcatSymOrNil(metatcb,ObjCEmptyVtableVar,compiler.deftypes.voidpointertype);
    { the read-only part }
    metatcb.emit_tai(Tai_const.Create_sym(metarosym),compiler.deftypes.voidpointertype);
    ...
    { the superclass }
    ConcatSymOrNil(isatcb,supersym,compiler.deftypes.voidpointertype);
    { pointer to cache }
    isatcb.emit_tai(Tai_const.Create_sym(ObjCEmptyCacheVar),compiler.deftypes.voidpointertype);
    { pointer to vtable }
    ConcatSymOrNil(isatcb,ObjCEmptyVtableVar,compiler.deftypes.voidpointertype);
    { the read-only part }
    isatcb.emit_tai(Tai_const.Create_sym(rosym),compiler.deftypes.voidpointertype);
...
procedure tobjcrttiwriter_nonfragile.addclasslist(list: tasmlist; section: tasmsectiontype; const symname: string; classes: tfpobjectlist);
  ...
  begin
    ...
    sym:=FAsmData.DefineAsmSymbol(symname,AB_LOCAL,AT_DATA,arrdef);
    tcb.maybe_begin_aggregate(arrdef);
    for i:=0 to classes.count-1 do
      tcb.emit_tai(
        tai_const.Create_sym(FAsmData.RefAsmSymbol(tobjectdef(classes[i]).rtti_mangledname(objcclassrtti),AT_DATA)),
