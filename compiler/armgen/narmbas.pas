...
interface
  ...
  uses
    nbas, ncgbas, nodeprinter, aasmtai;
...
{$endif aarch64}
  ...
  procedure TArmGenAsmNode.XMLProcessInstruction(var prn:tnodeprinter; p: tai);
    var
  ...
  procedure TArmGenAsmNode.XMLPrintNodeData(var prn:tnodeprinter);
    var
      hp: tai;
    begin
