        ...
        begin
          ...
          { check for allowed PPU versions }
            if not (ppufile.getversion = CurrentPPUVersion) then
             begin
               compiler.verbose.Message2(unit_u_ppu_invalid_version,tostr(ppufile.getversion),tostr(CurrentPPUVersion),@queuecomment);
               exit;
             end;
      ...
      function checkextraheader: boolean;
        begin
          ...
          if (longversion<>CurrentPPULongVersion) or
            ...
            begin
              compiler.verbose.Message2(unit_u_ppu_invalid_long_version,tostr(longversion),tostr(CurrentPPULongVersion),@queuecomment);
              exit;
            end;
{$ifdef i8086}
