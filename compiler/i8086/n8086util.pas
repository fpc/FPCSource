...
implementation
  ...
  class procedure ti8086nodeutils.InsertStackSegment;
    ...
    begin
      ...
      current_asmdata.asmlists[al_globals].concat(tai_symbol.Createname_global('___stack', AT_DATA, compiler.globals.stacksize, carraydef.getreusable(u8inttype,compiler.globals.stacksize)));
  ...
  class procedure ti8086nodeutils.InsertHeapSegment;
    ...
    begin
      ...
      current_asmdata.asmlists[al_globals].concat(tai_symbol.Createname_global('___heap', AT_DATA, compiler.globals.heapsize,carraydef.getreusable(u8inttype,heapsize)));
      { HACK: since tai_datablock's size parameter is aint, which cannot be
