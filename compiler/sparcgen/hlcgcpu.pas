...
implementation
  ...
  procedure thlcgcpu.g_intf_wrapper(list: TAsmList; procdef: tprocdef; const labelname: string; ioffset: longint);
    ...
    begin
      ...
      make_global:=false;
      if (not compiler.current_module.is_unit) or compiler.globals.create_smartlink or
  ...
  procedure thlcgcpu.a_jmp_external_name(list: TAsmList; const externalname: TSymStr);
    begin
      ...
      list.concat(taicpu.op_sym(A_CALL,list.AsmData.RefAsmSymbol(externalname,AT_FUNCTION)));
