      ...
      begin
         ...
         if left.nodetype<>typen then
           ...
           begin
             ...
             result:=compiler.ccallnode(nil,tprocsym(vs),vs.owner,self.getcopy,[],nil);
           end;
      end;
...
{$endif not cpu64bitaddr}
         ...
         if ((left.resultdef.typ=arraydef) and
             ...
             not(is_constnode(right) and (tarraydef(left.resultdef).elementdef.size=compiler.deftypes.alusinttype.size))) or
              ...
              if not is_const(right) then
                begin
                  ...
                  addstatement(stat,compiler.cassignmentnode(
                    compiler.ctemprefnode(temp),right)
                  );
