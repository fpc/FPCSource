...
procedure TCompiler.DefaultReplacements(var s:ansistring; substitute_env_variables:boolean=true);
  begin
    TReadOnlyCompilerGlobals.GlobalDefaultReplacements(globals,target,s,substitute_env_variables);
  end;
...
function TCompilerHelper.Getgenerrordef: tdef; inline;
begin
  Result := TCompiler(Self).generrordef;
end;
