...
{$endif cpu64bitaddr}
           ...
           AS_LCOMM:
             Begin
               ...
               curList.concat(Tai_datablock.Create(AsmData,commname,symofs,carraydef.getreusable(compiler.deftypes.u8inttype,symofs,compiler),AT_DATA));
               if actasmtoken<>AS_SEPARATOR then
                Consume(AS_SEPARATOR);
             end;
           ...
           AS_COMM:
             Begin
               ...
               Consume(AS_COMMA);
               symofs:=BuildConstExpression(false,false);
               curList.concat(Tai_datablock.Create_global(AsmData,commname,symofs,carraydef.getreusable(compiler.deftypes.u8inttype,symofs,compiler),AT_DATA));
               if actasmtoken<>AS_SEPARATOR then
                Consume(AS_SEPARATOR);
             end;
