...
{$endif not(defined(i386)) and not(defined(i8086)) and not(defined(avr))}
    ...
    function tcg.location_reg2string(const locreg: tlocation): string;
      begin
    ...
    procedure tcg.a_op_const_ref(list : TAsmList; Op: TOpCG; size: TCGSize; a: tcgint; const ref: TReference);
      ...
      begin
        if assigned(ref.symbol)
          ...
          {$ifdef avr}
            and not((CPUAVR_16_REGS in compiler.target.cpu_capabilities[compiler.globals.current_settings.cputype]) or (tcgsize2size[size]=1))
          {$endif avr} then
          begin
