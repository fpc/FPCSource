                            ...
                            begin
                              if not(assigned(exit_procinfo.nestedexitlabel)) then
                                begin
                                  ...
                                  exit_procinfo.nestedexitlabel.jumpbuf:=clocalvarsym.create('LABEL$_'+exit_procinfo.nestedexitlabel.name,vs_value,compiler.deftypes.rec_jmp_buf,[]);
...
{$if defined(i8086)}
                               ...
                               case tloadnode(p1).symtableentry.name of
                                 ...
                                 'MEML': p2:=compiler.ctypeconvnode_internal(p2,compiler.deftypes.longintfarpointertype);
                                 else
