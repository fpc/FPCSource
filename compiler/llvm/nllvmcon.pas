            ...
            case cst_type of
              ...
              cst_shortstring:
                { the resultdef of the string constant is the type of the
                  ...
                  correct string type }
                datadef:=carraydef.getreusable(compiler.deftypes.cansichartype,min(len,255)+1,compiler);
              else
      ...
      begin
         ...
         case tfloatdef(resultdef).floattype of
           ...
           s64currency:
             ...
             current_asmdata.CurrAsmList.concat(taillvm.op_reg_size_const_size(la_sitofp,location.register,compiler.deftypes.s64inttype,round(value_real),sc80floattype));
{$ifdef cpuextended}
           s80real,sc80real:
