                ...
                begin
                  ...
                  if tcgsize2size[def_cgsize(left.resultdef)]=1 then
                    begin
                      ...
                      current_asmdata.CurrAsmList.Concat(taicpu.op_const(A_CMP,0));
                    ...
                    begin
                      ...
                      for i:=1 to tcgsize2size[def_cgsize(left.resultdef)]-1 do
                        current_asmdata.CurrAsmList.Concat(taicpu.op_reg(A_ORA,cg.GetOffsetReg64(left.location.register,left.location.registerhi,i)));
                      cg.ungetcpuregister(current_asmdata.CurrAsmList,NR_A);
                    end;
                  location_reset(location,LOC_FLAGS,OS_NO);
