{
    ...
    This unit implements an asm for the MOS Technology 6502
...
{ This unit implements the assembler writer for the sdcc-sdas6502 assembler:
...
{$endif ARM}
    ...
    function TSdccSdas6500Assembler.sectionname(atype: TAsmSectiontype;
    ...
    procedure TSdccSdas6500Assembler.WriteSection(atype: TAsmSectiontype;
...
{$endif}
    ...
    procedure TSdccSdas6500Assembler.WriteOper(const o: toper; opcode: tasmop; ops: longint; dest: boolean);
      var
        need_plus: Boolean;
      begin
        case o.typ of
    ...
    procedure TSdccSdas6500Assembler.WriteOper_jmp(const o: toper; ai: taicpu);
      begin
        case o.typ of
          top_reg :
            writer.AsmWrite(std_regname(o.reg));
    ...
    procedure TSdccSdas6500Assembler.WriteExternals;
      var
        sym : TAsmSymbol;
        i   : longint;
      begin
...
{$endif EXTDEBUG}
    ...
    procedure TSdccSdas6500Assembler.WriteAsmList;
      var
        hal: TAsmListType;
      begin
        WriteExternals;
    ...
    function TSdccSdas6500Assembler.MakeCmdLine: TCmdStr;
      begin
    ...
    const
       as_sdcc_sdas6500_asm_info : tasminfo =
          (
            id     : as_sdcc_sdas6500;
...
begin
  RegisterAssembler(as_sdcc_sdas6500_asm_info,TSdccSdas6500Assembler);
end.
