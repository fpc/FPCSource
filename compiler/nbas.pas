...
{$endif DEBUG_NODE_XML}
    ...
    var
       ...
       function maybereplacewithtemp(compiler: TCompilerBase; var n: tnode; var block: tblocknode; var stat: tstatementnode; size: ASizeInt; allowreg: boolean): ttempcreatenode;
