    ...
    function trv64addnode.pass_1: tnode;
      begin
        if (nodetype=muln) and
           ...
           ([CPURV_HAS_MUL,CPURV_HAS_ZMMUL]*compiler.target.cpu_capabilities[compiler.globals.current_settings.cputype]<>[]) then
          begin
            result:=nil;
           ...
           ([CPURV_HAS_MUL,CPURV_HAS_ZMMUL]*compiler.target.cpu_capabilities[compiler.globals.current_settings.cputype]=[]) and
