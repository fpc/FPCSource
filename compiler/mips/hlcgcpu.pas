...
implementation
  ...
  begin
    ...
    begin
      { load VMT pointer }
      reference_reset_base(href,compiler.deftypes.voidpointertype,paraloc^.register,0,ctempposinvalid,sizeof(aint),[]);
      ...
      reference_reset_base(href, compiler.deftypes.voidpointertype, NR_VMT, tobjectdef(procdef.struct).vmtmethodoffset(procdef.extnumber), ctempposinvalid, sizeof(aint), []);
      list.concat(taicpu.op_reg_ref(A_LW,NR_PIC_FUNC,href));
      list.concat(taicpu.op_reg(A_JR, NR_PIC_FUNC));
    end
