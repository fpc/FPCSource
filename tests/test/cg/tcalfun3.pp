 ...
 {          (function return values with cdecl    calling cnvs)   }
...
function func_array: tsmallarray;cdecl;
 var
...
function func_largerecord: tlargerecord;cdecl;
 var
...
function func_shortstring: shortstring;cdecl;
 begin
   func_shortstring := RESULT_BIGSTRING;
 end;

function func_largeset : tlargeset;cdecl;
 var
  largeset : tlargeset;
 begin
  largeset := ['I'];
...
function func_u8bit : byte;cdecl;
 begin
   func_u8bit := RESULT_U8BIT;
 end;

function func_u16bit : word;cdecl;
 begin
   func_u16bit := RESULT_U16BIT;
 end;

function func_s32bit : longint;cdecl;
 begin
   func_s32bit := RESULT_S32BIT;
 end;

function func_s64bit : int64;cdecl;
 begin
   func_s64bit := RESULT_S64BIT;
 end;

function func_s32real : single;cdecl;
 begin
   func_s32real := RESULT_S32REAL;
 end;

function func_s64real : double;cdecl;
 begin
   func_s64real := RESULT_S64REAl;
 end;

function func_ansistring : ansistring;cdecl;
 begin
   func_ansistring := RESULT_BIGSTRING;
 end;

function func_pchar : pchar;cdecl;
 begin
...
{ LOC_MEM return values }
function func_array_mixed(b: byte): tsmallarray;cdecl;
 var
  local_b: byte;
  smallarray: tsmallarray;
 begin
...
function func_largerecord_mixed(b: byte): tlargerecord;cdecl;
 var
   local_b: byte;
   largerecord : tlargerecord;
 begin
...
function func_shortstring_mixed(b: byte): shortstring;cdecl;
 var
  local_b: byte;
 begin
...
function func_largeset_mixed(b: byte) : tlargeset;cdecl;
 var
  local_b: byte;
  largeset : tlargeset;
 begin
...
function func_u8bit_mixed(b: byte) : byte;cdecl;
 var
  local_b: byte;
 begin
...
function func_u16bit_mixed(b: byte) : word;cdecl;
 var
  local_b: byte;
 begin
...
function func_s32bit_mixed(b: byte) : longint;cdecl;
 var
  local_b: byte;
 begin
...
function func_s64bit_mixed(b: byte) : int64;cdecl;
 var
  local_b: byte;
 begin
...
function func_s32real_mixed(b: byte) : single;cdecl;
 var
  local_b: byte;
 begin
...
function func_s64real_mixed(b: byte) : double;cdecl;
 var
  local_b: byte;
 begin
...
function func_ansistring_mixed(b: byte) : ansistring;cdecl;
 var
  local_b: byte;
 begin
...
function func_pchar_mixed(b: byte) : pchar;cdecl;
 var
  local_b: byte;
 begin
...
function func_largerecord_mixed_nested(b: byte): tlargerecord;cdecl;
...
function func_shortstring_mixed_nested(b: byte): shortstring;cdecl;
...
function func_largeset_mixed_nested(b: byte) : tlargeset;cdecl;
...
function func_u8bit_mixed_nested(b: byte) : byte;cdecl;
...
function func_u16bit_mixed_nested(b: byte) : word;cdecl;
...
function func_s32bit_mixed_nested(b: byte) : longint;cdecl;
...
function func_s64bit_mixed_nested(b: byte) : int64;cdecl;
...
function func_s32real_mixed_nested(b: byte) : single;cdecl;
...
function func_s64real_mixed_nested(b: byte) : double;cdecl;
...
function func_ansistring_mixed_nested(b: byte) : ansistring;cdecl;
...
function func_pchar_mixed_nested(b: byte) : pchar;cdecl;
