 ...
 {          (function return values with register calling cnvs)   }
...
function func_array: tsmallarray;register;
 var
...
function func_largerecord: tlargerecord;register;
 var
...
function func_shortstring: shortstring;register;
 begin
   func_shortstring := RESULT_BIGSTRING;
 end;

function func_largeset : tlargeset;register;
 var
  largeset : tlargeset;
 begin
  largeset := ['I'];
...
function func_u8bit : byte;register;
 begin
   func_u8bit := RESULT_U8BIT;
 end;

function func_u16bit : word;register;
 begin
   func_u16bit := RESULT_U16BIT;
 end;

function func_s32bit : longint;register;
 begin
   func_s32bit := RESULT_S32BIT;
 end;

function func_s64bit : int64;register;
 begin
   func_s64bit := RESULT_S64BIT;
 end;

function func_s32real : single;register;
 begin
   func_s32real := RESULT_S32REAL;
 end;

function func_s64real : double;register;
 begin
   func_s64real := RESULT_S64REAl;
 end;

function func_ansistring : ansistring;register;
 begin
   func_ansistring := RESULT_BIGSTRING;
 end;

function func_pchar : pchar;register;
 begin
...
{ LOC_MEM return values }
function func_array_mixed(b: byte): tsmallarray;register;
 var
  local_b: byte;
  smallarray: tsmallarray;
 begin
...
function func_largerecord_mixed(b: byte): tlargerecord;register;
 var
   local_b: byte;
   largerecord : tlargerecord;
 begin
...
function func_shortstring_mixed(b: byte): shortstring;register;
 var
  local_b: byte;
 begin
...
function func_largeset_mixed(b: byte) : tlargeset;register;
 var
  local_b: byte;
  largeset : tlargeset;
 begin
...
function func_u8bit_mixed(b: byte) : byte;register;
 var
  local_b: byte;
 begin
...
function func_u16bit_mixed(b: byte) : word;register;
 var
  local_b: byte;
 begin
...
function func_s32bit_mixed(b: byte) : longint;register;
 var
  local_b: byte;
 begin
...
function func_s64bit_mixed(b: byte) : int64;register;
 var
  local_b: byte;
 begin
...
function func_s32real_mixed(b: byte) : single;register;
 var
  local_b: byte;
 begin
...
function func_s64real_mixed(b: byte) : double;register;
 var
  local_b: byte;
 begin
...
function func_ansistring_mixed(b: byte) : ansistring;register;
 var
  local_b: byte;
 begin
...
function func_pchar_mixed(b: byte) : pchar;register;
 var
  local_b: byte;
 begin
...
function func_largerecord_mixed_nested(b: byte): tlargerecord;register;
...
function func_shortstring_mixed_nested(b: byte): shortstring;register;
...
function func_largeset_mixed_nested(b: byte) : tlargeset;register;
...
function func_u8bit_mixed_nested(b: byte) : byte;register;
...
function func_u16bit_mixed_nested(b: byte) : word;register;
...
function func_s32bit_mixed_nested(b: byte) : longint;register;
...
function func_s64bit_mixed_nested(b: byte) : int64;register;
...
function func_s32real_mixed_nested(b: byte) : single;register;
...
function func_s64real_mixed_nested(b: byte) : double;register;
...
function func_ansistring_mixed_nested(b: byte) : ansistring;register;
...
function func_pchar_mixed_nested(b: byte) : pchar;register;
