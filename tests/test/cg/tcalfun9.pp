{ %maxversion=1.9.4 }
 ...
 {          (function return values with saveregs calling cnvs)   }
...
function func_array: tsmallarray;saveregisters;
 var
...
function func_largerecord: tlargerecord;saveregisters;
 var
...
function func_largeset : tlargeset;saveregisters;
 var
  largeset : tlargeset;
 begin
  largeset := ['I'];
...
function func_u8bit : byte;saveregisters;
 begin
   func_u8bit := RESULT_U8BIT;
 end;

function func_u16bit : word;saveregisters;
 begin
   func_u16bit := RESULT_U16BIT;
 end;

function func_s32bit : longint;saveregisters;
 begin
   func_s32bit := RESULT_S32BIT;
 end;

function func_s64bit : int64;saveregisters;
 begin
   func_s64bit := RESULT_S64BIT;
 end;

function func_s32real : single;saveregisters;
 begin
   func_s32real := RESULT_S32REAL;
 end;

function func_s64real : double;saveregisters;
 begin
   func_s64real := RESULT_S64REAl;
 end;

function func_ansistring : ansistring;saveregisters;
 begin
   func_ansistring := RESULT_BIGSTRING;
 end;

function func_pchar : pchar;saveregisters;
 begin
...
{ LOC_MEM return values }
function func_array_mixed(b: byte): tsmallarray;saveregisters;
 var
  local_b: byte;
  smallarray: tsmallarray;
 begin
...
function func_largerecord_mixed(b: byte): tlargerecord;saveregisters;
 var
   local_b: byte;
   largerecord : tlargerecord;
 begin
...
function func_shortstring_mixed(b: byte): shortstring;saveregisters;
 var
  local_b: byte;
 begin
...
function func_largeset_mixed(b: byte) : tlargeset;saveregisters;
 var
  local_b: byte;
  largeset : tlargeset;
 begin
...
function func_u8bit_mixed(b: byte) : byte;saveregisters;
 var
  local_b: byte;
 begin
...
function func_u16bit_mixed(b: byte) : word;saveregisters;
 var
  local_b: byte;
 begin
...
function func_s32bit_mixed(b: byte) : longint;saveregisters;
 var
  local_b: byte;
 begin
...
function func_s64bit_mixed(b: byte) : int64;saveregisters;
 var
  local_b: byte;
 begin
...
function func_s32real_mixed(b: byte) : single;saveregisters;
 var
  local_b: byte;
 begin
...
function func_s64real_mixed(b: byte) : double;saveregisters;
 var
  local_b: byte;
 begin
...
function func_ansistring_mixed(b: byte) : ansistring;saveregisters;
 var
  local_b: byte;
 begin
...
function func_pchar_mixed(b: byte) : pchar;saveregisters;
 var
  local_b: byte;
 begin
...
function func_largerecord_mixed_nested(b: byte): tlargerecord;saveregisters;
...
function func_shortstring_mixed_nested(b: byte): shortstring;saveregisters;
...
function func_largeset_mixed_nested(b: byte) : tlargeset;saveregisters;
...
function func_u8bit_mixed_nested(b: byte) : byte;saveregisters;
...
function func_u16bit_mixed_nested(b: byte) : word;saveregisters;
...
function func_s32bit_mixed_nested(b: byte) : longint;saveregisters;
...
function func_s64bit_mixed_nested(b: byte) : int64;saveregisters;
...
function func_s32real_mixed_nested(b: byte) : single;saveregisters;
...
function func_s64real_mixed_nested(b: byte) : double;saveregisters;
...
function func_ansistring_mixed_nested(b: byte) : ansistring;saveregisters;
...
function func_pchar_mixed_nested(b: byte) : pchar;saveregisters;
