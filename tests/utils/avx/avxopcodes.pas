...
{ $define TEST_SHA}
{ $define TEST_XSAVE}
{ $define TEST_AVX} {AVX,AVX2,SSE,SSE2,SSE3,SSE4,BMI1,BMI2...}
{$define TEST_ALL}
...
{$if defined(TEST_FP16) or defined(TEST_ALL)}
    { FP16 opcodes }
    FOpCodeList.Add('vmovw,1,1,1,XMMREG,RM32,,');   //-- provided for Gas compatibility
    //FOpCodeList.Add('vmovw,1,1,1,XMMREG,RM16,,'); //-- Gas does not accept reg16, but documentation states it has to be reg16
    //FOpCodeList.Add('vmovw,1,1,1,RM16,XMMREG,,'); //-- Gas does not accept reg16, but documentation states it has to be reg16
    FOpCodeList.Add('vmovw,1,1,1,RM32,XMMREG,,');   //-- provided for Gas compatibility
    FOpCodeList.Add('vmovsh,1,1,1,XMMREG_MZ,MEM16,,');
    FOpCodeList.Add('vmovsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG,');
    FOpCodeList.Add('vmovsh,1,1,1,MEM16_M,XMMREG,,');
    FOpCodeList.Add('vmovsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG,');
    FOpCodeList.Add('vaddph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vaddph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vaddph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vaddph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vaddph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vaddph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vaddph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vaddsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vaddsh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpeqph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpeqph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpeqph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpeqph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpeqph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpeqph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpeqph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpltph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpltph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpltph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpltph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpltph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpltph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpltph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpleph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpleph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpleph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpleph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpleph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpleph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpleph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpunordph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpunordph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpunordph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpunordph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpunordph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpunordph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpunordph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpneqph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpneqph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpneqph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpneqph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpneqph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpneqph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpneqph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpnltph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpnltph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpnltph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpnltph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpnltph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpnltph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpnltph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpnleph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpnleph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpnleph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpnleph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpnleph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpnleph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpnleph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpordph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpordph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpordph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpordph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpordph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpordph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpordph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpeq_uqph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpeq_uqph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpeq_uqph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpeq_uqph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpeq_uqph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpeq_uqph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpeq_uqph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpngeph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpngeph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpngeph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpngeph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpngeph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpngeph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpngeph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpngtph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpngtph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpngtph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpngtph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpngtph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpngtph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpngtph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpfalseph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpfalseph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpfalseph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpfalseph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpfalseph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpfalseph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpfalseph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpneq_oqph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpneq_oqph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpneq_oqph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpneq_oqph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpneq_oqph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpneq_oqph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpneq_oqph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpgeph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpgeph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpgeph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpgeph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpgeph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpgeph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpgeph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpgtph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpgtph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpgtph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpgtph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpgtph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpgtph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpgtph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmptrueph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmptrueph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmptrueph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmptrueph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmptrueph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmptrueph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmptrueph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpeq_osph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpeq_osph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpeq_osph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpeq_osph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpeq_osph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpeq_osph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpeq_osph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmplt_oqph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmplt_oqph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmplt_oqph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmplt_oqph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmplt_oqph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmplt_oqph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmplt_oqph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmple_oqph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmple_oqph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmple_oqph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmple_oqph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmple_oqph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmple_oqph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmple_oqph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpunord_sph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpunord_sph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpunord_sph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpunord_sph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpunord_sph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpunord_sph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpunord_sph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpneq_usph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpneq_usph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpneq_usph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpneq_usph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpneq_usph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpneq_usph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpneq_usph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpnlt_uqph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpnlt_uqph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpnlt_uqph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpnlt_uqph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpnlt_uqph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpnlt_uqph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpnlt_uqph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpnle_uqph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpnle_uqph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpnle_uqph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpnle_uqph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpnle_uqph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpnle_uqph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpnle_uqph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpord_sph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpord_sph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpord_sph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpord_sph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpord_sph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpord_sph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpord_sph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpeq_usph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpeq_usph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpeq_usph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpeq_usph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpeq_usph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpeq_usph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpeq_usph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpnge_uqph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpnge_uqph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpnge_uqph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpnge_uqph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpnge_uqph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpnge_uqph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpnge_uqph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpngt_uqph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpngt_uqph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpngt_uqph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpngt_uqph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpngt_uqph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpngt_uqph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpngt_uqph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpfalse_osph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpfalse_osph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpfalse_osph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpfalse_osph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpfalse_osph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpfalse_osph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpfalse_osph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpneq_osph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpneq_osph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpneq_osph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpneq_osph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpneq_osph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpneq_osph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpneq_osph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpge_oqph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpge_oqph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpge_oqph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpge_oqph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpge_oqph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpge_oqph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpge_oqph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpgt_oqph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmpgt_oqph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmpgt_oqph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmpgt_oqph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmpgt_oqph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmpgt_oqph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmpgt_oqph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmptrue_usph,1,1,1,KREG_M,XMMREG,XMMRM,');
    FOpCodeList.Add('vcmptrue_usph,1,1,1,KREG_M,XMMREG,8B16,');
    FOpCodeList.Add('vcmptrue_usph,1,1,1,KREG_M,YMMREG,YMMRM,');
    FOpCodeList.Add('vcmptrue_usph,1,1,1,KREG_M,YMMREG,16B16,');
    FOpCodeList.Add('vcmptrue_usph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vcmptrue_usph,1,1,1,KREG_M,ZMMREG,MEM512,');
    FOpCodeList.Add('vcmptrue_usph,1,1,1,KREG_M,ZMMREG,32B16,');
    FOpCodeList.Add('vcmpeqsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpeqsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpltsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpltsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmplesh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmplesh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpunordsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpunordsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpneqsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpneqsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpnltsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpnltsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpnlesh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpnlesh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpordsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpordsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpeq_uqsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpeq_uqsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpngesh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpngesh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpngtsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpngtsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpfalsesh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpfalsesh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpneq_oqsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpneq_oqsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpgesh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpgesh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpgtsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpgtsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmptruesh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmptruesh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpeq_ossh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpeq_ossh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmplt_oqsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmplt_oqsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmple_oqsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmple_oqsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpunord_ssh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpunord_ssh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpneq_ussh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpneq_ussh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpnlt_uqsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpnlt_uqsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpnle_uqsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpnle_uqsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpord_ssh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpord_ssh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpeq_ussh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpeq_ussh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpnge_uqsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpnge_uqsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpngt_uqsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpngt_uqsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpfalse_ossh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpfalse_ossh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpneq_ossh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpneq_ossh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpge_oqsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpge_oqsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpgt_oqsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmpgt_oqsh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmptrue_ussh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcmptrue_ussh,1,1,1,KREG_M,XMMREG,MEM16,');
    FOpCodeList.Add('vcmpph,1,1,1,KREG_M,XMMREG,XMMRM,IMM8');
    FOpCodeList.Add('vcmpph,1,1,1,KREG_M,XMMREG,8B16,IMM8');
    FOpCodeList.Add('vcmpph,1,1,1,KREG_M,YMMREG,YMMRM,IMM8');
    FOpCodeList.Add('vcmpph,1,1,1,KREG_M,YMMREG,16B16,IMM8');
    FOpCodeList.Add('vcmpph,1,1,1,KREG_M,ZMMREG,ZMMREG_SAE,IMM8');
    FOpCodeList.Add('vcmpph,1,1,1,KREG_M,ZMMREG,MEM512,IMM8');
    FOpCodeList.Add('vcmpph,1,1,1,KREG_M,ZMMREG,32B16,IMM8');
    FOpCodeList.Add('vcmpsh,1,1,1,KREG_M,XMMREG,XMMREG_SAE,IMM8');
    FOpCodeList.Add('vcmpsh,1,1,1,KREG_M,XMMREG,MEM16,IMM8');
    FOpCodeList.Add('VCOMISH,1,1,1,XMMREG,XMMREG_SAE,,');
    FOpCodeList.Add('VCOMISH,1,1,1,XMMREG,MEM16,,');
    FOpCodeList.Add('vcvtdq2ph,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtdq2ph,1,1,1,XMMREG_MZ,4B32,,');
    FOpCodeList.Add('vcvtdq2ph,1,1,1,XMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vcvtdq2ph,1,1,1,XMMREG_MZ,8B32,,');
    FOpCodeList.Add('vcvtdq2ph,1,1,1,YMMREG_MZ,ZMMREG_ER,,');
    FOpCodeList.Add('vcvtdq2ph,1,1,1,YMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vcvtdq2ph,1,1,1,YMMREG_MZ,16B32,,');
    FOpCodeList.Add('vcvtpd2ph,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtpd2ph,1,1,1,XMMREG_MZ,2B64,,');
    FOpCodeList.Add('vcvtpd2ph,1,1,1,XMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vcvtpd2ph,1,1,1,XMMREG_MZ,4B32,,');
    FOpCodeList.Add('vcvtpd2ph,1,1,1,XMMREG_MZ,ZMMREG_ER,,');
    FOpCodeList.Add('vcvtpd2ph,1,1,1,XMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vcvtpd2ph,1,1,1,XMMREG_MZ,8B32,,');
    FOpCodeList.Add('vcvtph2dq,1,1,1,XMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvtph2dq,1,1,1,XMMREG_MZ,MEM64,,');
    FOpCodeList.Add('vcvtph2dq,1,1,1,XMMREG_MZ,4B32,,');
    FOpCodeList.Add('vcvtph2dq,1,1,1,YMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtph2dq,1,1,1,YMMREG_MZ,8B32,,');
    FOpCodeList.Add('vcvtph2dq,1,1,1,ZMMREG_MZ,YMMREG_ER,,');
    FOpCodeList.Add('vcvtph2dq,1,1,1,ZMMREG_MZ,MEM256,,');
    FOpCodeList.Add('vcvtph2dq,1,1,1,ZMMREG_MZ,16B32,,');
    FOpCodeList.Add('vcvtph2pd,1,1,1,XMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvtph2pd,1,1,1,XMMREG_MZ,MEM32,,');
    FOpCodeList.Add('vcvtph2pd,1,1,1,XMMREG_MZ,2B64,,');
    FOpCodeList.Add('vcvtph2pd,1,1,1,YMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvtph2pd,1,1,1,YMMREG_MZ,MEM16,,');
    FOpCodeList.Add('vcvtph2pd,1,1,1,YMMREG_MZ,4B64,,');
    FOpCodeList.Add('vcvtph2pd,1,1,1,ZMMREG_MZ,XMMREG_SAE,,');
    FOpCodeList.Add('vcvtph2pd,1,1,1,ZMMREG_MZ,MEM128,,');
    FOpCodeList.Add('vcvtph2pd,1,1,1,ZMMREG_MZ,8B64,,');
    FOpCodeList.Add('vcvtph2psx,1,1,1,XMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvtph2psx,1,1,1,XMMREG_MZ,MEM64,,');
    FOpCodeList.Add('vcvtph2psx,1,1,1,XMMREG_MZ,4B32,,');
    FOpCodeList.Add('vcvtph2psx,1,1,1,YMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtph2psx,1,1,1,YMMREG_MZ,8B32,,');
    FOpCodeList.Add('vcvtph2psx,1,1,1,ZMMREG_MZ,YMMREG_SAE,,');
    FOpCodeList.Add('vcvtph2psx,1,1,1,ZMMREG_MZ,MEM256,,');
    FOpCodeList.Add('vcvtph2psx,1,1,1,ZMMREG_MZ,16B32,,');
    FOpCodeList.Add('vcvtph2qq,1,1,1,XMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvtph2qq,1,1,1,XMMREG_MZ,MEM32,,');
    FOpCodeList.Add('vcvtph2qq,1,1,1,XMMREG_MZ,2B64,,');
    FOpCodeList.Add('vcvtph2qq,1,1,1,YMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvtph2qq,1,1,1,YMMREG_MZ,MEM64,,');
    FOpCodeList.Add('vcvtph2qq,1,1,1,YMMREG_MZ,4B64,,');
    FOpCodeList.Add('vcvtph2qq,1,1,1,ZMMREG_MZ,XMMREG_ER,,');
    FOpCodeList.Add('vcvtph2qq,1,1,1,ZMMREG_MZ,MEM128,,');
    FOpCodeList.Add('vcvtph2qq,1,1,1,ZMMREG_MZ,8B64,,');
    FOpCodeList.Add('vcvtph2udq,1,1,1,XMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvtph2udq,1,1,1,XMMREG_MZ,MEM64,,');
    FOpCodeList.Add('vcvtph2udq,1,1,1,XMMREG_MZ,4B32,,');
    FOpCodeList.Add('vcvtph2udq,1,1,1,YMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtph2udq,1,1,1,YMMREG_MZ,8B32,,');
    FOpCodeList.Add('vcvtph2udq,1,1,1,ZMMREG_MZ,YMMREG_ER,,');
    FOpCodeList.Add('vcvtph2udq,1,1,1,ZMMREG_MZ,MEM256,,');
    FOpCodeList.Add('vcvtph2udq,1,1,1,ZMMREG_MZ,16B32,,');
    FOpCodeList.Add('vcvtph2uqq,1,1,1,XMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvtph2uqq,1,1,1,XMMREG_MZ,MEM32,,');
    FOpCodeList.Add('vcvtph2uqq,1,1,1,XMMREG_MZ,2B64,,');
    FOpCodeList.Add('vcvtph2uqq,1,1,1,YMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvtph2uqq,1,1,1,YMMREG_MZ,MEM64,,');
    FOpCodeList.Add('vcvtph2uqq,1,1,1,YMMREG_MZ,4B64,,');
    FOpCodeList.Add('vcvtph2uqq,1,1,1,ZMMREG_MZ,XMMREG_ER,,');
    FOpCodeList.Add('vcvtph2uqq,1,1,1,ZMMREG_MZ,MEM128,,');
    FOpCodeList.Add('vcvtph2uqq,1,1,1,ZMMREG_MZ,8B64,,');
    FOpCodeList.Add('vcvtph2uw,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtph2uw,1,1,1,XMMREG_MZ,8B16,,');
    FOpCodeList.Add('vcvtph2uw,1,1,1,YMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vcvtph2uw,1,1,1,YMMREG_MZ,16B16,,');
    FOpCodeList.Add('vcvtph2uw,1,1,1,ZMMREG_MZ,ZMMREG_ER,,');
    FOpCodeList.Add('vcvtph2uw,1,1,1,ZMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vcvtph2uw,1,1,1,ZMMREG_MZ,32B16,,');
    FOpCodeList.Add('vcvtph2w,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtph2w,1,1,1,XMMREG_MZ,8B16,,');
    FOpCodeList.Add('vcvtph2w,1,1,1,YMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vcvtph2w,1,1,1,YMMREG_MZ,16B16,,');
    FOpCodeList.Add('vcvtph2w,1,1,1,ZMMREG_MZ,ZMMREG_ER,,');
    FOpCodeList.Add('vcvtph2w,1,1,1,ZMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vcvtph2w,1,1,1,ZMMREG_MZ,32B16,,');
    FOpCodeList.Add('vcvtps2phx,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtps2phx,1,1,1,XMMREG_MZ,4B32,,');
    FOpCodeList.Add('vcvtps2phx,1,1,1,XMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vcvtps2phx,1,1,1,XMMREG_MZ,8B32,,');
    FOpCodeList.Add('vcvtps2phx,1,1,1,YMMREG_MZ,ZMMREG_ER,,');
    FOpCodeList.Add('vcvtps2phx,1,1,1,YMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vcvtps2phx,1,1,1,YMMREG_MZ,16B32,,');
    FOpCodeList.Add('vcvtqq2ph,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtqq2ph,1,1,1,XMMREG_MZ,2B64,,');
    FOpCodeList.Add('vcvtqq2ph,1,1,1,XMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vcvtqq2ph,1,1,1,XMMREG_MZ,4B32,,');
    FOpCodeList.Add('vcvtqq2ph,1,1,1,XMMREG_MZ,ZMMREG_ER,,');
    FOpCodeList.Add('vcvtqq2ph,1,1,1,XMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vcvtqq2ph,1,1,1,XMMREG_MZ,8B32,,');
    FOpCodeList.Add('vcvtsd2sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vcvtsd2sh,1,1,1,XMMREG_MZ,XMMREG,MEM64,');
    FOpCodeList.Add('vcvtsh2sd,1,1,1,XMMREG_MZ,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcvtsh2sd,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vcvtsh2si,1,1,1,REG32,XMMREG_ER,,');
    FOpCodeList.Add('vcvtsh2si,1,1,1,REG32,MEM16,,');
    FOpCodeList.Add('vcvtsh2si,0,1,1,REG64,XMMREG_ER,,');
    FOpCodeList.Add('vcvtsh2si,0,1,1,REG64,MEM16,,');
    FOpCodeList.Add('vcvtsh2ss,1,1,1,XMMREG_MZ,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vcvtsh2ss,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vcvtsh2usi,1,1,1,REG32,XMMREG_ER,,');
    FOpCodeList.Add('vcvtsh2usi,1,1,1,REG32,MEM16,,');
    FOpCodeList.Add('vcvtsh2usi,0,1,1,REG64,XMMREG_ER,,');
    FOpCodeList.Add('vcvtsh2usi,0,1,1,REG64,MEM16,,');
    FOpCodeList.Add('vcvtsi2sh,1,1,1,XMMREG,XMMREG_ER,REG32,');
    FOpCodeList.Add('vcvtsi2sh,1,1,1,XMMREG,XMMREG,MEM32,');
    FOpCodeList.Add('vcvtsi2sh,0,1,1,XMMREG,XMMREG_ER,REG64,');
    FOpCodeList.Add('vcvtsi2sh,0,1,1,XMMREG,XMMREG,MEM64,');
    FOpCodeList.Add('vcvtss2sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vcvtss2sh,1,1,1,XMMREG_MZ,XMMREG,MEM32,');
    FOpCodeList.Add('vcvttph2dq,1,1,1,XMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvttph2dq,1,1,1,XMMREG_MZ,MEM64,,');
    FOpCodeList.Add('vcvttph2dq,1,1,1,XMMREG_MZ,4B32,,');
    FOpCodeList.Add('vcvttph2dq,1,1,1,YMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvttph2dq,1,1,1,YMMREG_MZ,8B32,,');
    FOpCodeList.Add('vcvttph2dq,1,1,1,ZMMREG_MZ,YMMREG_SAE,,');
    FOpCodeList.Add('vcvttph2dq,1,1,1,ZMMREG_MZ,MEM256,,');
    FOpCodeList.Add('vcvttph2dq,1,1,1,ZMMREG_MZ,16B32,,');
    FOpCodeList.Add('vcvttph2qq,1,1,1,XMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvttph2qq,1,1,1,XMMREG_MZ,MEM32,,');
    FOpCodeList.Add('vcvttph2qq,1,1,1,XMMREG_MZ,2B64,,');
    FOpCodeList.Add('vcvttph2qq,1,1,1,YMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvttph2qq,1,1,1,YMMREG_MZ,MEM64,,');
    FOpCodeList.Add('vcvttph2qq,1,1,1,YMMREG_MZ,4B64,,');
    FOpCodeList.Add('vcvttph2qq,1,1,1,ZMMREG_MZ,XMMREG_SAE,,');
    FOpCodeList.Add('vcvttph2qq,1,1,1,ZMMREG_MZ,MEM128,,');
    FOpCodeList.Add('vcvttph2qq,1,1,1,ZMMREG_MZ,8B64,,');
    FOpCodeList.Add('vcvttph2udq,1,1,1,XMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvttph2udq,1,1,1,XMMREG_MZ,MEM64,,');
    FOpCodeList.Add('vcvttph2udq,1,1,1,XMMREG_MZ,4B32,,');
    FOpCodeList.Add('vcvttph2udq,1,1,1,YMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvttph2udq,1,1,1,YMMREG_MZ,8B32,,');
    FOpCodeList.Add('vcvttph2udq,1,1,1,ZMMREG_MZ,YMMREG_SAE,,');
    FOpCodeList.Add('vcvttph2udq,1,1,1,ZMMREG_MZ,MEM256,,');
    FOpCodeList.Add('vcvttph2udq,1,1,1,ZMMREG_MZ,16B32,,');
    FOpCodeList.Add('vcvttph2uqq,1,1,1,XMMREG_MZ,XMMREG,,');
    FOpCodeList.Add('vcvttph2uqq,1,1,1,XMMREG_MZ,MEM32,,');
    FOpCodeList.Add('vcvttph2uqq,1,1,1,XMMREG_MZ,2B64,,');
    FOpCodeList.Add('vcvttph2uqq,1,1,1,YMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvttph2uqq,1,1,1,YMMREG_MZ,MEM64,,');
    FOpCodeList.Add('vcvttph2uqq,1,1,1,YMMREG_MZ,4B64,,');
    FOpCodeList.Add('vcvttph2uqq,1,1,1,ZMMREG_MZ,XMMREG_SAE,,');
    FOpCodeList.Add('vcvttph2uqq,1,1,1,ZMMREG_MZ,MEM128,,');
    FOpCodeList.Add('vcvttph2uqq,1,1,1,ZMMREG_MZ,8B64,,');
    FOpCodeList.Add('vcvttph2uw,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvttph2uw,1,1,1,XMMREG_MZ,8B16,,');
    FOpCodeList.Add('vcvttph2uw,1,1,1,YMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vcvttph2uw,1,1,1,YMMREG_MZ,16B16,,');
    FOpCodeList.Add('vcvttph2uw,1,1,1,ZMMREG_MZ,ZMMREG_SAE,,');
    FOpCodeList.Add('vcvttph2uw,1,1,1,ZMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vcvttph2uw,1,1,1,ZMMREG_MZ,32B16,,');
    FOpCodeList.Add('vcvttph2w,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvttph2w,1,1,1,XMMREG_MZ,8B16,,');
    FOpCodeList.Add('vcvttph2w,1,1,1,YMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vcvttph2w,1,1,1,YMMREG_MZ,16B16,,');
    FOpCodeList.Add('vcvttph2w,1,1,1,ZMMREG_MZ,ZMMREG_SAE,,');
    FOpCodeList.Add('vcvttph2w,1,1,1,ZMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vcvttph2w,1,1,1,ZMMREG_MZ,32B16,,');
    FOpCodeList.Add('vcvttsh2si,1,1,1,REG32,XMMREG_SAE,,');
    FOpCodeList.Add('vcvttsh2si,1,1,1,REG32,MEM16,,');
    FOpCodeList.Add('vcvttsh2si,0,1,1,REG64,XMMREG_SAE,,');
    FOpCodeList.Add('vcvttsh2si,0,1,1,REG64,MEM16,,');
    FOpCodeList.Add('vcvttsh2usi,1,1,1,REG32,XMMREG_SAE,,');
    FOpCodeList.Add('vcvttsh2usi,1,1,1,REG32,MEM16,,');
    FOpCodeList.Add('vcvttsh2usi,0,1,1,REG64,XMMREG_SAE,,');
    FOpCodeList.Add('vcvttsh2usi,0,1,1,REG64,MEM16,,');
    FOpCodeList.Add('vcvtudq2ph,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtudq2ph,1,1,1,XMMREG_MZ,4B32,,');
    FOpCodeList.Add('vcvtudq2ph,1,1,1,XMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vcvtudq2ph,1,1,1,XMMREG_MZ,8B32,,');
    FOpCodeList.Add('vcvtudq2ph,1,1,1,YMMREG_MZ,ZMMREG_ER,,');
    FOpCodeList.Add('vcvtudq2ph,1,1,1,YMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vcvtudq2ph,1,1,1,YMMREG_MZ,16B32,,');
    FOpCodeList.Add('vcvtuqq2ph,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtuqq2ph,1,1,1,XMMREG_MZ,2B64,,');
    FOpCodeList.Add('vcvtuqq2ph,1,1,1,XMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vcvtuqq2ph,1,1,1,XMMREG_MZ,4B32,,');
    FOpCodeList.Add('vcvtuqq2ph,1,1,1,XMMREG_MZ,ZMMREG_ER,,');
    FOpCodeList.Add('vcvtuqq2ph,1,1,1,XMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vcvtuqq2ph,1,1,1,XMMREG_MZ,8B32,,');
    FOpCodeList.Add('vcvtusi2sh,1,1,1,XMMREG,XMMREG_ER,REG32,');
    FOpCodeList.Add('vcvtusi2sh,1,1,1,XMMREG,XMMREG,MEM32,');
    FOpCodeList.Add('vcvtusi2sh,0,1,1,XMMREG,XMMREG_ER,REG64,');
    FOpCodeList.Add('vcvtusi2sh,0,1,1,XMMREG,XMMREG,MEM64,');
    FOpCodeList.Add('vcvtuw2ph,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtuw2ph,1,1,1,XMMREG_MZ,8B16,,');
    FOpCodeList.Add('vcvtuw2ph,1,1,1,YMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vcvtuw2ph,1,1,1,YMMREG_MZ,16B16,,');
    FOpCodeList.Add('vcvtuw2ph,1,1,1,ZMMREG_MZ,ZMMREG_ER,,');
    FOpCodeList.Add('vcvtuw2ph,1,1,1,ZMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vcvtuw2ph,1,1,1,ZMMREG_MZ,32B16,,');
    FOpCodeList.Add('vcvtw2ph,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vcvtw2ph,1,1,1,XMMREG_MZ,8B16,,');
    FOpCodeList.Add('vcvtw2ph,1,1,1,YMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vcvtw2ph,1,1,1,YMMREG_MZ,16B16,,');
    FOpCodeList.Add('vcvtw2ph,1,1,1,ZMMREG_MZ,ZMMREG_ER,,');
    FOpCodeList.Add('vcvtw2ph,1,1,1,ZMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vcvtw2ph,1,1,1,ZMMREG_MZ,32B16,,');
    FOpCodeList.Add('vdivph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vdivph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vdivph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vdivph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vdivph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vdivph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vdivph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vdivsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vdivsh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfcmaddcph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfcmaddcph,1,1,1,XMMREG_MZ,XMMREG,4B32,');
    FOpCodeList.Add('vfcmaddcph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfcmaddcph,1,1,1,YMMREG_MZ,YMMREG,8B32,');
    FOpCodeList.Add('vfcmaddcph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfcmaddcph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfcmaddcph,1,1,1,ZMMREG_MZ,ZMMREG,16B32,');
    FOpCodeList.Add('vfcmaddcsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfcmaddcsh,1,1,1,XMMREG_MZ,XMMREG,MEM32,');
    FOpCodeList.Add('vfmaddcph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmaddcph,1,1,1,XMMREG_MZ,XMMREG,4B32,');
    FOpCodeList.Add('vfmaddcph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmaddcph,1,1,1,YMMREG_MZ,YMMREG,8B32,');
    FOpCodeList.Add('vfmaddcph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmaddcph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmaddcph,1,1,1,ZMMREG_MZ,ZMMREG,16B32,');
    FOpCodeList.Add('vfmaddcsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfmaddcsh,1,1,1,XMMREG_MZ,XMMREG,MEM32,');
    FOpCodeList.Add('vfcmulcph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfcmulcph,1,1,1,XMMREG_MZ,XMMREG,4B32,');
    FOpCodeList.Add('vfcmulcph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfcmulcph,1,1,1,YMMREG_MZ,YMMREG,8B32,');
    FOpCodeList.Add('vfcmulcph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfcmulcph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfcmulcph,1,1,1,ZMMREG_MZ,ZMMREG,16B32,');
    FOpCodeList.Add('vfcmulcsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfcmulcsh,1,1,1,XMMREG_MZ,XMMREG,MEM32,');
    FOpCodeList.Add('vfmulcph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmulcph,1,1,1,XMMREG_MZ,XMMREG,4B32,');
    FOpCodeList.Add('vfmulcph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmulcph,1,1,1,YMMREG_MZ,YMMREG,8B32,');
    FOpCodeList.Add('vfmulcph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmulcph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmulcph,1,1,1,ZMMREG_MZ,ZMMREG,16B32,');
    FOpCodeList.Add('vfmulcsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfmulcsh,1,1,1,XMMREG_MZ,XMMREG,MEM32,');
    FOpCodeList.Add('vfmaddsub132ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmaddsub132ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfmaddsub132ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmaddsub132ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfmaddsub132ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmaddsub132ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmaddsub132ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfmaddsub213ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmaddsub213ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfmaddsub213ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmaddsub213ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfmaddsub213ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmaddsub213ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmaddsub213ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfmaddsub231ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmaddsub231ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfmaddsub231ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmaddsub231ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfmaddsub231ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmaddsub231ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmaddsub231ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfmsubadd132ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmsubadd132ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfmsubadd132ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmsubadd132ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfmsubadd132ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmsubadd132ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmsubadd132ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfmsubadd213ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmsubadd213ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfmsubadd213ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmsubadd213ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfmsubadd213ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmsubadd213ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmsubadd213ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfmsubadd231ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmsubadd231ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfmsubadd231ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmsubadd231ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfmsubadd231ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmsubadd231ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmsubadd231ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfmadd132ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmadd132ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfmadd132ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmadd132ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfmadd132ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmadd132ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmadd132ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfmadd213ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmadd213ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfmadd213ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmadd213ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfmadd213ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmadd213ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmadd213ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfmadd231ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmadd231ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfmadd231ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmadd231ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfmadd231ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmadd231ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmadd231ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfnmadd132ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfnmadd132ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfnmadd132ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfnmadd132ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfnmadd132ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfnmadd132ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfnmadd132ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfnmadd213ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfnmadd213ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfnmadd213ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfnmadd213ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfnmadd213ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfnmadd213ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfnmadd213ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfnmadd231ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfnmadd231ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfnmadd231ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfnmadd231ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfnmadd231ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfnmadd231ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfnmadd231ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfmadd132sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfmadd132sh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfmadd213sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfmadd213sh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfmadd231sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfmadd231sh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfnmadd132sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfnmadd132sh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfnmadd213sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfnmadd213sh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfnmadd231sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfnmadd231sh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfmsub132ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmsub132ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfmsub132ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmsub132ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfmsub132ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmsub132ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmsub132ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfmsub213ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmsub213ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfmsub213ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmsub213ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfmsub213ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmsub213ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmsub213ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfmsub231ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfmsub231ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfmsub231ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfmsub231ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfmsub231ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfmsub231ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfmsub231ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfnmsub132ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfnmsub132ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfnmsub132ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfnmsub132ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfnmsub132ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfnmsub132ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfnmsub132ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfnmsub213ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfnmsub213ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfnmsub213ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfnmsub213ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfnmsub213ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfnmsub213ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfnmsub213ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfnmsub231ph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vfnmsub231ph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vfnmsub231ph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vfnmsub231ph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vfnmsub231ph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vfnmsub231ph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vfnmsub231ph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vfmsub132sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfmsub132sh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfmsub213sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfmsub213sh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfmsub231sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfmsub231sh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfnmsub132sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfnmsub132sh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfnmsub213sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfnmsub213sh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfnmsub231sh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vfnmsub231sh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vfpclassph,1,1,1,KREG_M,XMMRM,IMM8');
    FOpCodeList.Add('vfpclassph,1,1,1,KREG_M,8B16,IMM8');
    FOpCodeList.Add('vfpclassph,1,1,1,KREG_M,YMMRM,IMM8');
    FOpCodeList.Add('vfpclassph,1,1,1,KREG_M,16B16,IMM8');
    FOpCodeList.Add('vfpclassph,1,1,1,KREG_M,ZMMREG_SAE,IMM8');
    FOpCodeList.Add('vfpclassph,1,1,1,KREG_M,MEM512,IMM8');
    FOpCodeList.Add('vfpclassph,1,1,1,KREG_M,32B16,IMM8');
    FOpCodeList.Add('vfpclasssh,1,1,1,KREG_M,XMMREG_SAE,IMM8');
    FOpCodeList.Add('vfpclasssh,1,1,1,KREG_M,MEM16,IMM8');
    FOpCodeList.Add('vgetexpph,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vgetexpph,1,1,1,XMMREG_MZ,8B16,,');
    FOpCodeList.Add('vgetexpph,1,1,1,YMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vgetexpph,1,1,1,YMMREG_MZ,16B16,,');
    FOpCodeList.Add('vgetexpph,1,1,1,ZMMREG_MZ,ZMMREG_SAE,,');
    FOpCodeList.Add('vgetexpph,1,1,1,ZMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vgetexpph,1,1,1,ZMMREG_MZ,32B16,,');
    FOpCodeList.Add('vgetexpsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vgetexpsh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vgetmantph,1,1,1,XMMREG_MZ,XMMRM,IMM8,');
    FOpCodeList.Add('vgetmantph,1,1,1,XMMREG_MZ,8B16,IMM8,');
    FOpCodeList.Add('vgetmantph,1,1,1,YMMREG_MZ,YMMRM,IMM8,');
    FOpCodeList.Add('vgetmantph,1,1,1,YMMREG_MZ,16B16,IMM8,');
    FOpCodeList.Add('vgetmantph,1,1,1,ZMMREG_MZ,ZMMREG_SAE,IMM8,');
    FOpCodeList.Add('vgetmantph,1,1,1,ZMMREG_MZ,MEM512,IMM8,');
    FOpCodeList.Add('vgetmantph,1,1,1,ZMMREG_MZ,32B16,IMM8,');
    FOpCodeList.Add('vgetmantsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_SAE,IMM8');
    FOpCodeList.Add('vgetmantsh,1,1,1,XMMREG_MZ,XMMREG,MEM16,IMM8');
    FOpCodeList.Add('vmaxph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vmaxph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vmaxph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vmaxph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vmaxph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vmaxph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vmaxph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vmaxsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vmaxsh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vminph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vminph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vminph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vminph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vminph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_SAE,');
    FOpCodeList.Add('vminph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vminph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vminsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_SAE,');
    FOpCodeList.Add('vminsh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vmulph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vmulph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vmulph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vmulph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vmulph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vmulph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vmulph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vmulsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vmulsh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vrcpph,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vrcpph,1,1,1,XMMREG_MZ,8B16,,');
    FOpCodeList.Add('vrcpph,1,1,1,YMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vrcpph,1,1,1,YMMREG_MZ,16B16,,');
    FOpCodeList.Add('vrcpph,1,1,1,ZMMREG_MZ,ZMMRM,,');
    FOpCodeList.Add('vrcpph,1,1,1,ZMMREG_MZ,32B16,,');
    FOpCodeList.Add('vrcpsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG,');
    FOpCodeList.Add('vrcpsh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vreduceph,1,1,1,XMMREG_MZ,XMMRM,IMM8,');
    FOpCodeList.Add('vreduceph,1,1,1,XMMREG_MZ,8B16,IMM8,');
    FOpCodeList.Add('vreduceph,1,1,1,YMMREG_MZ,YMMRM,IMM8,');
    FOpCodeList.Add('vreduceph,1,1,1,YMMREG_MZ,16B16,IMM8,');
    FOpCodeList.Add('vreduceph,1,1,1,ZMMREG_MZ,ZMMREG_SAE,IMM8,');
    FOpCodeList.Add('vreduceph,1,1,1,ZMMREG_MZ,MEM512,IMM8,');
    FOpCodeList.Add('vreduceph,1,1,1,ZMMREG_MZ,32B16,IMM8,');
    FOpCodeList.Add('vreducesh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_SAE,IMM8');
    FOpCodeList.Add('vreducesh,1,1,1,XMMREG_MZ,XMMREG,MEM16,IMM8');
    FOpCodeList.Add('vrndscaleph,1,1,1,XMMREG_MZ,XMMRM,IMM8,');
    FOpCodeList.Add('vrndscaleph,1,1,1,XMMREG_MZ,8B16,IMM8,');
    FOpCodeList.Add('vrndscaleph,1,1,1,YMMREG_MZ,YMMRM,IMM8,');
    FOpCodeList.Add('vrndscaleph,1,1,1,YMMREG_MZ,16B16,IMM8,');
    FOpCodeList.Add('vrndscaleph,1,1,1,ZMMREG_MZ,ZMMREG_SAE,IMM8,');
    FOpCodeList.Add('vrndscaleph,1,1,1,ZMMREG_MZ,MEM512,IMM8,');
    FOpCodeList.Add('vrndscaleph,1,1,1,ZMMREG_MZ,32B16,IMM8,');
    FOpCodeList.Add('vrndscalesh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_SAE,IMM8');
    FOpCodeList.Add('vrndscalesh,1,1,1,XMMREG_MZ,XMMREG,MEM16,IMM8');
    FOpCodeList.Add('vrsqrtph,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vrsqrtph,1,1,1,XMMREG_MZ,8B16,,');
    FOpCodeList.Add('vrsqrtph,1,1,1,YMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vrsqrtph,1,1,1,YMMREG_MZ,16B16,,');
    FOpCodeList.Add('vrsqrtph,1,1,1,ZMMREG_MZ,ZMMRM,,');
    FOpCodeList.Add('vrsqrtph,1,1,1,ZMMREG_MZ,32B16,,');
    FOpCodeList.Add('vrsqrtsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG,');
    FOpCodeList.Add('vrsqrtsh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vscalefph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vscalefph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vscalefph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vscalefph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vscalefph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vscalefph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vscalefph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vscalefsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vscalefsh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vsqrtph,1,1,1,XMMREG_MZ,XMMRM,,');
    FOpCodeList.Add('vsqrtph,1,1,1,XMMREG_MZ,8B16,,');
    FOpCodeList.Add('vsqrtph,1,1,1,YMMREG_MZ,YMMRM,,');
    FOpCodeList.Add('vsqrtph,1,1,1,YMMREG_MZ,16B16,,');
    FOpCodeList.Add('vsqrtph,1,1,1,ZMMREG_MZ,ZMMREG_ER,,');
    FOpCodeList.Add('vsqrtph,1,1,1,ZMMREG_MZ,MEM512,,');
    FOpCodeList.Add('vsqrtph,1,1,1,ZMMREG_MZ,32B16,,');
    FOpCodeList.Add('vsqrtsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vsqrtsh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vsubph,1,1,1,XMMREG_MZ,XMMREG,XMMRM,');
    FOpCodeList.Add('vsubph,1,1,1,XMMREG_MZ,XMMREG,8B16,');
    FOpCodeList.Add('vsubph,1,1,1,YMMREG_MZ,YMMREG,YMMRM,');
    FOpCodeList.Add('vsubph,1,1,1,YMMREG_MZ,YMMREG,16B16,');
    FOpCodeList.Add('vsubph,1,1,1,ZMMREG_MZ,ZMMREG,ZMMREG_ER,');
    FOpCodeList.Add('vsubph,1,1,1,ZMMREG_MZ,ZMMREG,MEM512,');
    FOpCodeList.Add('vsubph,1,1,1,ZMMREG_MZ,ZMMREG,32B16,');
    FOpCodeList.Add('vsubsh,1,1,1,XMMREG_MZ,XMMREG,XMMREG_ER,');
    FOpCodeList.Add('vsubsh,1,1,1,XMMREG_MZ,XMMREG,MEM16,');
    FOpCodeList.Add('vucomish,1,1,1,XMMREG,XMMREG_SAE,,');
    FOpCodeList.Add('vucomish,1,1,1,XMMREG,MEM16,,');
{$endif}
{$if defined(TEST_BF16) or defined(TEST_ALL)}
    { BF16 opcodes }
    FOpCodeList.Add('VCVTNE2PS2BF16,1,1,1,XMMREG_MZ,XMMREG,XMMRM');
    FOpCodeList.Add('VCVTNE2PS2BF16,1,1,1,XMMREG,XMMREG,4B32');
    FOpCodeList.Add('VCVTNE2PS2BF16,1,1,1,YMMREG_MZ,YMMREG,YMMRM');
    FOpCodeList.Add('VCVTNE2PS2BF16,1,1,1,YMMREG,YMMREG,8B32');
    FOpCodeList.Add('VCVTNE2PS2BF16,1,1,1,ZMMREG_MZ,ZMMREG,ZMMRM');
    FOpCodeList.Add('VCVTNE2PS2BF16,1,1,1,ZMMREG,ZMMREG,16B32');
    FOpCodeList.Add('VCVTNEPS2BF16,1,1,1,XMMREG_MZ,XMMREG');
    FOpCodeList.Add('VCVTNEPS2BF16,1,1,1,XMMREG_MZ,MEM128');
    FOpCodeList.Add('VCVTNEPS2BF16,1,1,1,XMMREG,4B32');
    FOpCodeList.Add('VCVTNEPS2BF16,1,1,1,XMMREG_MZ,YMMREG');
    FOpCodeList.Add('VCVTNEPS2BF16,1,1,1,XMMREG_MZ,MEM256');
    FOpCodeList.Add('VCVTNEPS2BF16,1,1,1,XMMREG,8B32');
    FOpCodeList.Add('VCVTNEPS2BF16,1,1,1,YMMREG_MZ,ZMMREG');
    FOpCodeList.Add('VCVTNEPS2BF16,1,1,1,YMMREG_MZ,MEM512');
    FOpCodeList.Add('VCVTNEPS2BF16,1,1,1,YMMREG,16B32');
    FOpCodeList.Add('VDPBF16PS,1,1,1,XMMREG_MZ,XMMREG,XMMRM');
    FOpCodeList.Add('VDPBF16PS,1,1,1,XMMREG,XMMREG,4B32');
    FOpCodeList.Add('VDPBF16PS,1,1,1,YMMREG_MZ,YMMREG,YMMRM');
    FOpCodeList.Add('VDPBF16PS,1,1,1,YMMREG,YMMREG,8B32');  //-- ok, but Nasm 2.17rc fail this
    FOpCodeList.Add('VDPBF16PS,1,1,1,ZMMREG_MZ,ZMMREG,ZMMRM');
    FOpCodeList.Add('VDPBF16PS,1,1,1,ZMMREG,ZMMREG,16B32'); //-- ok, but Nasm 2.17rc fail this
{$endif}
{$if defined(TEST_VP2INTERSECT) or defined(TEST_ALL)}
    ...
    FOpCodeList.Add('VP2INTERSECTD,1,1,1,KREG,YMMREG,8B32');  //-- ok, but Nasm 2.17rc fail this
    FOpCodeList.Add('VP2INTERSECTD,1,1,1,KREG,ZMMREG,ZMMRM');
    FOpCodeList.Add('VP2INTERSECTD,1,1,1,KREG,ZMMREG,16B32'); //-- ok, but Nasm 2.17rc fail this

    FOpCodeList.Add('VP2INTERSECTQ,1,1,1,KREG,XMMREG,XMMRM'); { VP2INTERSECTQ not implemented in Nasm 2.17rc }
...
{$if defined(TEST_SM) or defined(TEST_ALL)}
    { SM3 opcodes }
    FOpCodeList.Add('VSM3RNDS2,1,1,0,XMMREG,XMMREG,XMMRM,IMM8');  //-- in Nasm 2.17rc implemented only XMMREG
    FOpCodeList.Add('VSM3MSG1,1,1,0,XMMREG,XMMREG,XMMRM');        //-- in Nasm 2.17rc implemented only XMMREG
    FOpCodeList.Add('VSM3MSG2,1,1,0,XMMREG,XMMREG,XMMRM');        //-- in Nasm 2.17rc implemented only XMMREG

    { SM4 opcodes }
    FOpCodeList.Add('VSM4KEY4,1,1,1,XMMREG,XMMREG,XMMRM'); //-- not implemented EVEX encoding in Nasm 2.17rc  (only VEX)
    FOpCodeList.Add('VSM4KEY4,1,1,1,YMMREG,YMMREG,YMMRM'); //-- not implemented EVEX encoding in Nasm 2.17rc  (only VEX)
    FOpCodeList.Add('VSM4KEY4,1,1,1,ZMMREG,ZMMREG,ZMMRM'); //-- not implemented in Nasm 2.17rc
    FOpCodeList.Add('VSM4RNDS4,1,1,1,XMMREG,XMMREG,XMMRM');  //-- not implemented EVEX encoding in Nasm 2.17rc  (only VEX)
    FOpCodeList.Add('VSM4RNDS4,1,1,1,YMMREG,YMMREG,YMMRM');  //-- not implemented EVEX encoding in Nasm 2.17rc  (only VEX)
...
{$if defined(TEST_XSAVE) or defined(TEST_ALL)}
  ...
  FOpCodeList.Add('XSAVE64,0,1,0,MEM64,,,,');
  FOpCodeList.Add('XRSTOR,1,1,0,MEM64,,,,');
  FOpCodeList.Add('XRSTOR64,0,1,0,MEM64,,,,');
  FOpCodeList.Add('XSAVEOPT,1,1,0,MEM64,,,,');
  FOpCodeList.Add('XSAVEOPT64,0,1,0,MEM64,,,,');
...
//  FOpCodeList.Add('CMPSS,1,1,0,XMMREG,MEM32,IMM8,,');
  ...
  FOpCodeList.Add('cvtsd2si,1,1,0,REG32,XMMREG,,');
  FOpCodeList.Add('cvtsd2si,1,1,0,REG64,MEM64,,');
  FOpCodeList.Add('cvtsd2si,1,1,0,REG64,XMMREG,,');
  FOpCodeList.Add('cvtss2si,1,1,0,REG32,MEM32,,');
  FOpCodeList.Add('cvtss2si,1,1,0,REG32,XMMREG,,');
  FOpCodeList.Add('cvtss2si,1,1,0,REG64,MEM32,,');
  FOpCodeList.Add('cvtss2si,1,1,0,REG64,XMMREG,,');
  ...
  FOpCodeList.Add('vcvtsi2ss,1,1,1,XMMREG,XMMREG,MEM32,');
  FOpCodeList.Add('vcvtsi2ss,0,1,1,XMMREG,XMMREG,MEM64,');
...
//  FOpCodeList.Add('vpclmulqdq,1,1,1,ZMMREG,ZMMREG,ZMMRM,IMM8');
  ...
  FOpCodeList.Add('vpextrq,0,1,1,RM64,XMMREG,IMM8,');
  ...
  FOpCodeList.Add('vcvtusi2sd,1,1,1,xmmreg,xmmreg,reg32,');
  FOpCodeList.Add('vcvtusi2sd,1,1,1,xmmreg,xmmreg,mem32,');
  FOpCodeList.Add('vcvtusi2sd,0,1,1,xmmreg,xmmreg_er,reg64,');
  FOpCodeList.Add('vcvtusi2sd,0,1,1,xmmreg,xmmreg,mem64,');
  FOpCodeList.Add('vcvtusi2ss,1,1,1,xmmreg,xmmreg_er,reg32,');
  FOpCodeList.Add('vcvtusi2ss,1,1,1,xmmreg,xmmreg,mem32,');
  FOpCodeList.Add('vcvtusi2ss,0,1,1,xmmreg,xmmreg_er,reg64,');
  FOpCodeList.Add('vcvtusi2ss,0,1,1,xmmreg,xmmreg,mem64,');
