...
no meaning, hence the directive is ignored. A warning is printed to the screen, telling
you so.
...
\begin{remark}If you compile assembler code using the inline assembler
readers you must declare any labels you use in the assembler
code and use \var{\{\$GOTO ON\}}.
\end{remark}
...
equivalent to the command-line switch \var{-Si}. For more information on
inline routines, consult the \refref.
...
compiler generates this code, you must switch it on using the \var{-Ci}
command-line switch.
