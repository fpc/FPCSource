...
begin
  ...
  42:
                        HandleCallingConvention(_PACKED); // Not exactly calling convention, but follows same logic.
  43:
  ...
  47:
                        HandleCallingConvention(CALLBACK); // Callback, really ?
  48:
                        HandleCPlusPlus(VOID);
  49:
                        HandleCPlusPlus(VOID);
  50:
  ...
  66:
                        HandlePreProcDefine;
  67:
                        HandleCPlusPlus(_CHAR);
  68:
                        HandleCPlusPlus(UNION);
  69:
                        HandleCPlusPlus(ENUM);
  70:
                        HandleCPlusPlus(STRUCT);
  71:
                        HandleCPlusPlus(LGKLAMMER);
  72:
                        HandleCPlusPlus(RGKLAMMER);
  73:
                        HandleCPlusPlus(TYPEDEF);
  74:
                        HandleCPlusPlus(INT);
  75:
                        HandleCPlusPlus(SHORT);
  76:
                        HandleCPlusPlus(LONG);
  77:
                        HandleCPlusPlus(SIGNED);
  78:
                        HandleCPlusPlus(UNSIGNED);
  79:
                        HandleCPlusPlus(INT8);
  80:
                        HandleCPlusPlus(INT16);
  81:
                        HandleCPlusPlus(INT32);
  82:
                        HandleCPlusPlus(INT64);
  83:
                        HandleCPlusPlus(INT8);
  84:
                        HandleCPlusPlus(INT16);
  ...
  86:
                        HandleCPlusPlus(INT64);
  87:
                        HandleCPlusPlus(FLOAT);
  88:
                        HandleCPlusPlus(_CONST);
  89:
                        HandleCPlusPlus(_CONST);
  90:
                        HandleCPlusPlus(_FAR);
  91:
                        HandleCPlusPlus(_FAR);
  92:
                        HandleCPlusPlus(_NEAR);
  93:
                        HandleCPlusPlus(_NEAR);
  94:
                        HandleCPlusPlus(_HUGE);
  95:
                        HandleCPlusPlus(_HUGE);
  96:
                        HandleCPlusPlus(_WHILE);
  97:
                        HandleIdentifier;
  98:
