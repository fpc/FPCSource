...
{$endif ALLPACKAGES}
    ...
    //P.Targets.AddUnit('lnet/lfastcgi.pp', lnetOSes).install:=false;
    ...
    P.Targets.AddUnit('lnet/lwebserver.pp', lnetOSes).install:=false;
    ...
    P.Targets.AddUnit('lnet/lws2tcpip.pp', lnetOSes).install:=false;
