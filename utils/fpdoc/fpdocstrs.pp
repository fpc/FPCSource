...
resourcestring
  ...
  // Material usage
  SMaterialWriterDescr      = 'HTML output with the page layout of the mkdocs material theme.';
  SMaterialUsageScheme      = 'Colour scheme to start with: auto, light or dark. Default is auto';
  SMaterialUsageColor       = 'Primary colour: a material colour name such as indigo, or a CSS colour';
  SMaterialUsageAccent      = 'Colour of links and other accents, same values as --material-color';
  SMaterialUsageTitle       = 'Title shown in the header of every page';
  SMaterialUsageLogo        = 'Image file shown left of the title. It is copied to the output';
  SMaterialUsageFavIcon     = 'Image file used as browser icon. It is copied to the output';
  SMaterialUsageJSFile      = 'Use file instead of the built-in javascript file';
  SMaterialUsageNoSearch    = 'Do not write the identifier index used by the search box';
  SMaterialUsageSearchLimit = 'Show at most N search results at a time';
  SMaterialUsageNoTOC       = 'Do not show the contents of the page in the right sidebar';
  SMaterialUsageNoNavScript = 'Do not write the navigation tree as a script file';
  SMaterialUsageDumpAssets  = 'Write the built-in style sheet and script to directory DIR';

  // Material output
  SMaterialGeneratedBy      = 'Generated by fpdoc';
  SMaterialBackToTop        = 'Back to top';
  SMaterialTableOfContents  = 'Contents';
  SMaterialSkipToContent    = 'Skip to content';
  SMaterialPermanentLink    = 'Permanent link';
  SMaterialCopyToClipboard  = 'Copy to clipboard';
  SMaterialImplements       = 'Implements:';
  SMaterialReadOnly         = 'read only';
