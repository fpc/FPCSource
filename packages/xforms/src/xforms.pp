...
type
 ...
 TFL_PUP_ENTRY = record
      TheText : PAnsiChar;          { label of a popup/menu item    }
      CallBack : PFL_PUP_CB;            { the callback function         }
      shortcut : PAnsiChar;             { hotkeys                       }
...
Tflobjs = record
    ...
    thelabel : PAnsiChar;           { object label                       }
    ...
    c_cdata : PAnsiChar;            { For class use }
...
Tform = record
    ...
    thelabel : PAnsiChar;           { window title            }
...
Function fl_get_vn_value (p1 : PFL_VN_PAIR; p2 : PAnsiChar) : Longint; cdecl;external;
Function fl_get_vn_name (p1 : PFL_VN_PAIR; p2 : Longint ) : PAnsiChar; cdecl;external;
...
Procedure fl_set_form_title(p1 : PFL_FORM; p2 : PAnsiChar); cdecl;external;
...
Function fl_show_form (p1 : PFL_FORM; p2,p3 : Longint ; p4 : PAnsiChar) : Longint; cdecl;external;
...
Procedure fl_prepare_form_window(p1 : PFL_FORM; p2,p3 :  Longint ; p4 : PAnsiChar); cdecl;external;
...
Procedure fl_set_object_shortcut(p1 : PFL_OBJECT; p2 : PAnsiChar;p3 : Longint ); cdecl;external;
...
Procedure fl_set_object_label(p1 : PFL_OBJECT; p2 :  PAnsiChar); cdecl;external;
...
Type TFL_ENUMERATEPTR = Procedure (p : PAnsiChar);  cdecl;
     PFL_ENUMERATEPTR = ^TFL_ENUMERATEPTR;

Procedure fl_enumerate_fonts (p1 : PFL_ENUMERATEPTR; p2 :  longint); cdecl;external;

Function  fl_set_font_name(p1 : Longint ; p2 :  PAnsiChar) : longint; cdecl;external;
...
Function fl_get_string_height(p1 : Longint ; p2 : Longint ; p3 : PAnsiChar; p4 : Longint ; p5,p6 : pointer) : Longint ; cdecl;external;
Function fl_get_string_width(p1 : Longint ; p2 : Longint ; p3 : PAnsiChar; p4 : Longint ) : Longint ; cdecl;external;
Function fl_get_string_widthTAB(p1 : Longint ; p2 : Longint ; p3 : PAnsiChar; p4 : Longint ) : Longint ; cdecl;external;
Function fl_get_string_dimension(p1 : Longint ; p2 : Longint ; p3 : PAnsiChar; p4 : Longint ; p5,p6 : pointer) : Longint ; cdecl;external;
{
...
Procedure fl_drw_text(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord; p6 : TFL_COLOR; p7,p8 : Longint ; p9 : PAnsiChar); cdecl;external;

Procedure fl_drw_text_beside(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord; p6 : TFL_COLOR; p7,p8 : Longint ; p9 : PAnsiChar); cdecl;external;
{
...
Procedure fl_drw_text_cursor(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6,p7,p8: Longint ; p9 : PAnsiChar; p10,p11: Longint ); cdecl;external;
...
Function fl_add_symbol(p1 : PAnsiChar; p2 : PFL_DRAWPTR; p3 :Longint ) : Longint ; cdecl;external;
Function fl_draw_symbol(p1 : PAnsiChar; p2,p3,p4,p5 : TFL_Coord;p6 : TFL_COLOR) : Longint ; cdecl;external;
...
Procedure fl_drw_slider (p1 :longint; p2,p3,P4,p5 : TFL_COORD; p6,p7 : TFL_COLOR;
                         p8 : Longint; p9,p10 : double; P11 : PAnsiChar; p12,p13,p14 : Longint);cdecl;external;


Function fl_mapcolor(p1 : TFL_COLOR; p2,p3,p4 : Longint ) : cardinal; cdecl;external;
Function fl_mapcolorname(p1 : TFL_COLOR; p2 :  PAnsiChar) : longint; cdecl;external;
{
...
type TFL_FSCB = Function (p1 : PAnsiChar; p2 : pointer) : Longint; cdecl;
PFL_FSCB = ^TFL_FSCB;
...
Function fl_make_object(p1 : Longint ; p2,p3,p4,p5,p6 : TFL_Coord; p7 : PAnsiChar; P8 : PFL_HANDLEPTR) : PFL_OBJECT; cdecl;external;
...
Function fl_whoami : PAnsiChar; cdecl;external;
Function fl_now : PAnsiChar; cdecl;external;
...
type
 FL_FONT = record
    ...
    fname : Array[1..80] of AnsiChar;               { without size info     }
end;
...
Procedure fl_dashedlinestyle(p1 : PAnsiChar; p2 :  Longint ); cdecl;external;
...
Function fl_wincreate(p1 : PAnsiChar) : TWindow;  cdecl;external;
Function fl_winshow(p1 : TWindow) : TWindow;  cdecl;external;
Function fl_winopen(p1 : PAnsiChar) : TWindow;  cdecl;external;
...
Procedure fl_wintitle(p1 : TWindow; p2 :  PAnsiChar); cdecl;external;
...
Function fl_print_xevent_name(p1 : PAnsiChar; p2 : PXEvent) : PXEvent; cdecl;external;
...
Function fl_initialize(p1 : pointer; p2 : PPAnsiChar; p3 :PAnsiChar; p4 : PFL_CMD_OPT; p5 : Longint ) : Pdisplay; cdecl;external;
Procedure fl_finish;   cdecl;external;

{ addfromhere }

Function fl_get_resource(p1 : PAnsiChar; p2 :  PAnsiChar; p3 : TFL_RTYPE; p4 : PAnsiChar; p5 : pointer; p6 :Longint ) : PAnsiChar; cdecl;external;
Procedure fl_set_resource(p1 : PAnsiChar; p2 :  PAnsiChar); cdecl;external;
...
Type TFL_IOPT =  record
    ...
    borderWidth,
    safe : Longint ;
    rgbfile : PAnsiChar;            { where RGB file is     }
    vname : array [0..23] of AnsiChar;
end;
PFL_IOPT = ^TFL_IOPT;
...
Procedure fl_set_tabstop(p1 : PAnsiChar);  cdecl;external;
Procedure fl_get_defaults(p1 : PFL_IOPT);  cdecl;external;
Function fl_get_visual_depth : Longint;  cdecl;external;
Function fl_vclass_name(p1 : Longint ) : PAnsiChar;  cdecl;external;
Function fl_vclass_val(p1 : PAnsiChar) : Longint ;  cdecl;external;
...
{**** Routines ****}
Function fl_create_bitmap(p1 : Longint ; p2 : TFL_Coord; p3 : TFL_Coord; p4 : TFL_Coord; p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_bitmap(p1 : Longint ; p2 : TFL_Coord; p3 : TFL_Coord; p4 : TFL_Coord; p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Procedure fl_set_bitmap_data(p1 : PFL_OBJECT; p2 : Longint ; p3 : Longint ; p4 : pointer); cdecl;external;
Procedure fl_set_bitmap_file(p1 : PFL_OBJECT; p2 :  PAnsiChar); cdecl;external;
Function fl_read_bitmapfile(p1 : TWindow; p2 :  PAnsiChar; p3,p4 : pword; p5,p6 : pointer) : TPixmap ; cdecl;external;

{
#define fl_create_from_bitmapdata(p1 : win; p2 : data; p3 : w; p4 : h)\
                   XCreateBitmapFromData(p1 : fl_get_display(p1 : ); p2 : win; p3 :\
                   (p1 : AnsiChar *)data; p2 : w; p3 :h)
...
Function fl_create_pixmap(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord; p6  :PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_pixmap(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;

Procedure fl_set_pixmap_data(p1 : PFL_OBJECT; p2 :  PPAnsiChar); cdecl;external;
Procedure fl_set_pixmap_file(p1 : PFL_OBJECT; p2 :  PAnsiChar); cdecl;external;
...
Function fl_read_pixmapfile(p1 : TWindow; p2 :  PAnsiChar;p3,p4 : pword; p5 : PPixmap;p6,p7 : pointer; p8 : TFL_COLOR)  : TPixmap ; cdecl;external;
Function fl_create_from_pixmapdata(p1 : TWindow; p2 :  PPAnsiChar;p3,p4 : pword; p5 : PPixmap;p6,p7 : pointer; p8 : TFL_COLOR) : TPixmap ; cdecl;external;
{
#define fl_free_pixmap(p1 : id)  if(p1 : id != None) XFreePixmap(p1 : fl_display; p2 :  id);
}

Function fl_create_box(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_box(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
...
Function fl_create_browser(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_browser(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6:  PAnsiChar) : PFL_OBJECT; cdecl;external;
Procedure fl_clear_browser(p1 : PFL_OBJECT); cdecl;external;
Procedure fl_add_browser_line(p1 : PFL_OBJECT; p2 :  PAnsiChar); cdecl;external;
Procedure fl_addto_browser(p1 : PFL_OBJECT; p2 :  PAnsiChar); cdecl;external;
Procedure fl_addto_browserchars(p1 : PFL_OBJECT; p2 :  PAnsiChar); cdecl;external;

Procedure fl_insert_browser_line(p1 : PFL_OBJECT; p2 : Longint ; p3 :PAnsiChar); cdecl;external;
Procedure fl_delete_browser_line(p1 : PFL_OBJECT; p2 :  Longint ); cdecl;external;
Procedure fl_replace_browser_line(p1 : PFL_OBJECT; p2 : Longint ; p3 :PAnsiChar); cdecl;external;
Function fl_get_browser_line(p1 : PFL_OBJECT; p2 :  Longint  ) : PAnsiChar; cdecl;external;
Function fl_load_browser(p1 : PFL_OBJECT; p2 :  PAnsiChar ) : Longint ; cdecl;external;
...
Function fl_create_button(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_create_roundbutton(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_create_round3dbutton(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_create_lightbutton(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_create_checkbutton(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_create_bitmapbutton(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_create_pixmapbutton(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6 :  PAnsiChar) : PFL_OBJECT; cdecl;external;

Function fl_add_roundbutton(p1 : Longint ; p2,p3,p4,p5 :TFL_Coord; p6:  PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_round3dbutton(p1 : Longint ; p2,p3,p4,p5 :TFL_Coord; p6:  PAnsiChar) : PFL_OBJECT; cdecl;external;

Function fl_add_lightbutton(p1 : Longint ; p2,p3,p4,p5 :TFL_Coord; p6:  PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_checkbutton(p1 : Longint ; p2,p3,p4,p5 :TFL_Coord; p6:  PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_button(p1 : Longint ; p2,p3,p4,p5 :TFL_Coord; p6:  PAnsiChar) : PFL_OBJECT; cdecl;external;


Procedure fl_set_bitmapbutton_data (p1 : PFL_OBJECT; p2,p3 : Longint ;   p4 : PAnsiChar); cdecl;external;
Procedure fl_set_bitmapbutton_file (p1 : PFL_OBJECT; p2: PAnsiChar); cdecl;external;
Function  fl_add_bitmapbutton (p1 : longint; p2,p3,p4,p5: TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;

{
#define fl_set_bitmapbutton_datafile  fl_set_bitmapbutton_file
}

Function fl_add_pixmapbutton(p1 : Longint ; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Procedure fl_set_pixmapbutton_data(p1 : PFL_OBJECT; p2 :  PPAnsiChar);
Procedure fl_set_pixmapbutton_file(p1 : PFL_OBJECT; p2 :  PAnsiChar);
...
Procedure fl_set_button_shortcut(p1 : PFL_OBJECT; p2 : PAnsiChar;p3 : Longint );

Function fl_create_generic_button(p1,p2 : Longint ; p3,p4,p5,p6 : TFL_Coord;p7 : PAnsiChar) : PFL_OBJECT; cdecl;external;
...
Function fl_create_generic_canvas(p1 : Longint; p2 : Longint ; p3,p4,p5,p6 : TFL_Coord; p7 : PAnsiChar) : PFL_OBJECT; cdecl;external;

Function fl_add_canvas(p1 : Longint; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar): PFL_OBJECT; cdecl;external;

Function fl_create_canvas(p1 : Longint; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;

Function fl_create_mesacanvas(p1 : Longint; p2,p3,p4,p5 : TFL_Coord;p6 :  PAnsiChar) : PFL_OBJECT; cdecl;external;

Function fl_add_mesacanvas(p1 : Longint; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
...
{ OpenGL canvases }
Function fl_create_glcanvas(p1 : Longint; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;

Function fl_add_glcanvas(p1 : Longint; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
...
Function fl_create_chart(p1 : Longint; p2,p3,p4,p5 : TFL_Coord; p6 :  PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_chart(p1 : longint; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;

Procedure fl_clear_chart(p1 : PFL_OBJECT); cdecl;external;
Procedure fl_add_chart_value(p1 : PFL_OBJECT; p2 : double; p3 : PAnsiChar; p4 : Longint ); cdecl;external;
Procedure fl_insert_chart_value(p1 : PFL_OBJECT; p2 : Longint ; p3 : double; p4 : PAnsiChar; p5 : Longint ); cdecl;external;
Procedure fl_replace_chart_value(p1 : PFL_OBJECT; p2 : Longint ; p3 : double; p4 : PAnsiChar; p5 : Longint ); cdecl;external;
...
Function fl_create_choice(p1 : longint; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) :  PFL_OBJECT; cdecl;external;

Function fl_add_choice(p1 : longint; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar ) : PFL_OBJECT; cdecl;external;
Procedure fl_clear_choice(p1 : PFL_OBJECT);   cdecl;external;
Procedure fl_addto_choice(p1 : PFL_OBJECT; p2 :  PAnsiChar); cdecl;external;
Procedure fl_replace_choice(p1 : PFL_OBJECT; p2 : Longint ; p3 :PAnsiChar); cdecl;external;
...
Procedure fl_set_choice_text(p1 : PFL_OBJECT; p2 :  PAnsiChar); cdecl;external;
Function fl_get_choice(p1 : PFL_OBJECT ) : Longint ; cdecl;external;
Function fl_get_choice_item_text(p1 : PFL_OBJECT; p2 :  Longint  ) : PAnsiChar; cdecl;external;
Function fl_get_choice_maxitems(p1 : PFL_OBJECT ) : Longint ;  cdecl;external;
Function fl_get_choice_text(p1 : PFL_OBJECT ) : PAnsiChar; cdecl;external;
...
Procedure fl_set_choice_item_shortcut(p1 : PFL_OBJECT; p2 : Longint ; p3 :PAnsiChar); cdecl;external;
...
Function fl_create_clock(p1 : longint; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;

Function fl_add_clock(p1 : longint; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
...
Function fl_create_counter(p1 : longint; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;

Function fl_add_counter(p1 : longint; p2,p3,p4,p5 : TFL_Coord;p6: PAnsiChar) : PFL_OBJECT; cdecl;external;
...
{
                                  PAnsiChar(p1 : *)(p1 : PFL_OBJECT; p2 : double; p3 :Longint ));
}
...
Function fl_create_bitmap_cursor(p1 : PAnsiChar; p2 :  PAnsiChar; p3,p4,p5,p6 : Longint ) : TCursor; cdecl;external;
...
Function fl_create_dial(p1 : longint; p2,p3,p4,p5 : TFL_Coord;p6 :PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_dial(p1 : longint; p2,p3,p4,p5 : TFL_Coord;p6: PAnsiChar) : PFL_OBJECT; cdecl;external;
...
TFL_DIRLIST_FILTER = Procedure (p1 : PAnsiChar; p2 :  Longint ); cdecl;
...
Function fl_get_dirlist(p1 : PAnsiChar; p2 : PAnsiChar; p3 : pointer;p4 :longint) : PFL_Dirlist;        { rescan } cdecl;external;
...
Function fl_is_valid_dir(p1 : PAnsiChar ) : Longint; cdecl;external;
Function fl_fmtime(p1 : PAnsiChar ) : cardinal ;  cdecl;external;
Function fl_fix_dirname(p1 : PAnsiChar) : PAnsiChar;  cdecl;external;
...
Function fl_object_ps_dump (p1 : PFL_OBJECT; p2 : PAnsiChar) : longint; cdecl;external;
...
Function fl_create_frame(p1 : longint; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_frame(p1 : longint; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_create_labelframe(p1 : longint; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_labelframe(p1 : longint; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
...
Function fl_create_free(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord;p6: PAnsiChar; p7 : PFL_HANDLEPTR) : PFL_OBJECT; cdecl;external;
Function fl_add_free(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar; P7 : PFL_HANDLEPTR) : PFL_OBJECT; cdecl;external;
...
Procedure fl_show_message(p1 : PAnsiChar; p2 : PAnsiChar; p3 :PAnsiChar); cdecl;external;
Procedure fl_show_messages(p1 : PAnsiChar); cdecl;external;
Procedure fl_show_alert(p1 : PAnsiChar; p2 : PAnsiChar; p3 : PAnsiChar; p4 : Longint ); cdecl;external;
Function fl_show_question(p1 : PAnsiChar; p2 : longint) : Longint ; cdecl;external;
Function fl_show_input(p1 : PAnsiChar; p2 :  PAnsiChar ) : PAnsiChar; cdecl;external;
Function fl_show_simple_input(p1 : PAnsiChar; p2 :  PAnsiChar ) : PAnsiChar; cdecl;external;
Function fl_show_colormap(p1 : Longint ) : Longint ;   cdecl;external;
Function fl_show_choice(p1,p2,p3 : PAnsiChar; p4 : Longint ; p5,p6,p7 : PAnsiChar; p8 : Longint) : Longint; cdecl;external;
Function fl_show_choices(p1 : PAnsiChar; p4 : Longint ; p5,p6,p7 : PAnsiChar; p8 : Longint) : Longint; cdecl;external;
Procedure fl_set_choices_shortcut(p1,p2,p3 :PAnsiChar); cdecl;external;

Procedure fl_show_oneliner(p1 : PAnsiChar; p2 : TFL_Coord; p3 :TFL_Coord); cdecl;external;
...
Function fl_exe_command(p1 : PAnsiChar; p2 : Longint) : Longint; cdecl;external;
...
Procedure fl_addto_command_log(p1 : PAnsiChar); cdecl;external;
...
Function fl_show_fselector(p1,p2,p3,p4 :  PAnsiChar) : PAnsiChar; cdecl;external;
...
Type TFSelector_Callback = Function (P1 : PAnsiChar; P2 : Pointer) : Longint;  cdecl;
...
Function fl_get_filename : PAnsiChar; cdecl;external;
Function fl_get_directory : PAnsiChar;  cdecl;external;
Function fl_get_pattern : PAnsiChar;   cdecl;external;
Function fl_set_directory (p1 : PAnsiChar ) : LongInt;  cdecl;external;
Procedure fl_set_pattern (p1 : PAnsiChar); cdecl;external;
Procedure fl_refresh_fselector;  cdecl;external;
Procedure fl_add_fselector_appbutton(p1 : PAnsiChar; p2 : PFL_Procedure; p3 : pointer); cdecl;external;
Procedure fl_remove_fselector_appbutton(p1 : PAnsiChar); cdecl;external;
...
Function fl_create_input(p1 : Longint; p2,p3,p4,p5 : TFL_Coord; p6: PAnsiChar) : PFL_OBJECT; cdecl;external;

Function fl_add_input(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord; P6 : PAnsiChar ) : PFL_OBJECT; cdecl;external;

Procedure fl_set_input(p1 : PFL_OBJECT; p2 :  PAnsiChar); cdecl;external;
...
Function fl_get_input(p1 : PFL_OBJECT ) : PAnsiChar;   cdecl;external;
...
Function fl_get_input_selected_range(p1 : PFL_OBJECT; p2 : Longint ; p3 :Longint ) : PAnsiChar ;  cdecl;external;



type
 TFL_INPUTVALIDATOR = Procedure (p1 : PFL_OBJECT; p2,p3 : PAnsiChar; p4 : Longint ); cdecl;
...
type TFL_EditKeymap = record
    { basic editing }
    del_prev_char : Longint;            { delete previous AnsiChar    }
    del_next_char : Longint;            { delete next AnsiChar        }
    ...
    moveto_prev_char : Longint; { one AnsiChar left            }
    moveto_next_char : Longint; { one AnsiChar right           }
...
Function fl_create_menu(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord; P6 : PAnsiChar) : PFL_OBJECT; cdecl;external;

Function fl_add_menu(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord; P6 : PAnsiChar) : PFL_OBJECT; cdecl;external;

Procedure fl_clear_menu(p1 : PFL_OBJECT);  cdecl;external;
Procedure fl_set_menu(p1 : PFL_OBJECT; p2 :  PAnsiChar); cdecl;external;
Procedure fl_addto_menu(p1 : PFL_OBJECT; p2 :  PAnsiChar); cdecl;external;
Procedure fl_replace_menu_item(p1 : PFL_OBJECT; p2 : Longint ; p3 :PAnsiChar); cdecl;external;
Procedure fl_delete_menu_item(p1 : PFL_OBJECT; p2 :  Longint ); cdecl;external;

Procedure fl_set_menu_item_shortcut(p1 : PFL_OBJECT; p2 : Longint ; p3 :PAnsiChar); cdecl;external;
...
Function fl_get_menu_item_text(p1 : PFL_OBJECT; p2 :  Longint  ) : PAnsiChar; cdecl;external;
...
Function fl_get_menu_text(p1 : PFL_OBJECT ) : PAnsiChar; cdecl;external;
...
Function fl_create_menubar(p1 : longint; p2,p3,p4,p5 : TFL_COORD;p6 : PAnsiChar): PFL_OBJECT; cdecl;external;
Function fl_add_menubar(p1 : longint;p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;

Procedure fl_clear_menubar(p1 : PFL_OBJECT); cdecl;external;
Procedure fl_set_menubar(p1 : PFL_OBJECT; p2 : PAnsiChar); cdecl;external;
Procedure fl_set_menubar_entries(p1 : PFL_OBJECT; p2 : PAnsiChar;p3 : PFL_PUP_ENTRY); cdecl;external;
...
Function fl_defpup(p1 : TWindow; p2 :  PAnsiChar) : LongInt; cdecl;external;
Function fl_addtopup(p1 : longint; p2 :  PAnsiChar) : LongInt; cdecl;external;
...
Procedure fl_setpup_shortcut(p1 : Longint; p2 : Longint ; p3 :PAnsiChar); cdecl;external;
...
Procedure fl_setpup_title(p1 : LongInt; p2 :  PAnsiChar); cdecl;external;
...
Function fl_getpup_text(p1 : LongInt; p2 :  Longint  ) : PAnsiChar; cdecl;external;
...
Function fl_create_positioner(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_positioner(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
...
Function  fl_create_scrollbar(p1 : longint;p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT ; cdecl;external;
Function  fl_add_scrollbar(p1 : longint;p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT ; cdecl;external;
...
Function fl_create_slider(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord;p6: PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_slider(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord;p6: PAnsiChar) : PFL_OBJECT; cdecl;external;

Function fl_create_valslider(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord;p6: PAnsiChar): PFL_OBJECT; cdecl;external;
Function fl_add_valslider(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord;P6: PAnsiChar) : PFL_OBJECT; cdecl;external;
...
Function fl_create_tabfolder (p1 : longint;p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT ; cdecl;external;
Function fl_add_tabfolder(p1 : longint;p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT ; cdecl;external;
Function fl_addto_tabfolder(p1 : PFL_OBJECT; p2 : PAnsiChar; p3 : PFL_FORM) : PFL_OBJECT; cdecl;external;
...
Procedure fl_delete_folder_byname(p1 : PFL_OBJECT; p2 : PAnsiChar); cdecl;external;

Procedure fl_set_folder(p1 : PFL_OBJECT; P2 : PFL_FORM); cdecl;external;
Procedure fl_set_folder_byname(p1 : PFL_OBJECT; p2 : PAnsiChar); cdecl;external;
...
Function fl_get_folder_name(p1 : PFL_OBJECT) : PAnsiChar; cdecl;external;
...
Function fl_get_active_folder_name(p1 : PFL_OBJECT) : PAnsiChar; cdecl;external;
...
Function fl_create_text(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_text(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord; p6 : PAnsiChar): PFL_OBJECT; cdecl;external;
...
Type TFL_TIMER_FILTER = Function (P1 : PFL_OBJECT;p2 : double) : PAnsiChar; cdecl;
     PFL_TIMER_FILTER = ^TFL_TIMER_FILTER;

{**** Routines ****}

Function fl_create_timer(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord;p6 : PAnsiChar) : PFL_OBJECT; cdecl;external;

Function fl_add_timer(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord;p6: PAnsiChar) : PFL_OBJECT; cdecl;external;
...
Function fl_create_xyplot(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord; p6: PAnsiChar) : PFL_OBJECT; cdecl;external;
Function fl_add_xyplot(p1 : LongInt; p2,p3,p4,p5 : TFL_Coord; P6 : PAnsiChar ) : PFL_OBJECT; cdecl;external;
Procedure fl_set_xyplot_data(p1 : PFL_OBJECT; p2,p3 : pfloat; p4 : Longint ; p5,p6,p7 : PAnsiChar); cdecl;external;
Procedure fl_set_xyplot_file(p1 : PFL_OBJECT; p2,p3,p4,p5 :PAnsiChar); cdecl;external;
...
Procedure fl_set_xyplot_alphaxtics(p1 : PFL_OBJECT; p2,p3 : PAnsiChar); cdecl;external;
Procedure fl_set_xyplot_alphaytics(p1 : PFL_OBJECT; p2,p3 : PAnsiChar); cdecl;external;
Procedure fl_set_xyplot_fixed_xaxis(p1 : PFL_OBJECT; p2,p3 : PAnsiChar); cdecl;external;
Procedure fl_set_xyplot_fixed_yaxis(p1 : PFL_OBJECT; p2,p3 : PAnsiChar); cdecl;external;
...
Procedure fl_add_xyplot_text(p1 : PFL_OBJECT; p2,p3 : double; p4 : PAnsiChar;p5 : Longint ; p6 :TFL_COLOR); cdecl;external;
Procedure fl_add_xyplot_overlay(p1 : PFL_OBJECT; p2 : Longint ; p3,p4 : pfloat; p5 : Longint ; p6 :TFL_COLOR); cdecl;external;
Procedure fl_delete_xyplot_text(p1 : PFL_OBJECT; p2 :  PAnsiChar); cdecl;external;
