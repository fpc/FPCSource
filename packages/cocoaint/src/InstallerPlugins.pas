...
{$ifdef COCOAALL}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesAppKit, Api.Cocoa.DefinedClassesInstallerPlugins, System.CTypes, Api.Cocoa.CocoaAll, MacOsApi.MacOSAll;
	{$else}
...
{$else}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesAppKit, Api.Cocoa.DefinedClassesInstallerPlugins, Api.Cocoa.AppKit, Api.Cocoa.Foundation, System.CTypes, MacOSAll;
	{$else}
