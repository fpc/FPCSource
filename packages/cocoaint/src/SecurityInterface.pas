...
{$ifdef COCOAALL}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesFoundation, Api.Cocoa.DefinedClassesSecurityInterface, Api.Cocoa.SecurityFoundation, System.CTypes, Api.Cocoa.CocoaAll, MacOsApi.MacOSAll;
	{$else}
...
{$else}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesFoundation, Api.Cocoa.DefinedClassesSecurityInterface, Api.Cocoa.Foundation, Api.Cocoa.SecurityFoundation, Api.Cocoa.AppKit, System.CTypes, MacOSAll;
	{$else}
