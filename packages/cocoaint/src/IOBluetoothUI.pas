...
{$include iobluetoothui/UndefinedTypes.inc}

{$define TYPES}
{$include iobluetoothui/Sources.inc}
{$undef TYPES}
...
{$include iobluetoothui/InlineFunctions.inc}
