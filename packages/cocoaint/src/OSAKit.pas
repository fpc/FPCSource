...
{$ifdef COCOAALL}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesAppKit, Api.Cocoa.DefinedClassesFoundation, Api.Cocoa.DefinedClassesOSAKit, System.CTypes, Api.Cocoa.CocoaAll, MacOsApi.MacOSAll;
	{$else}
...
{$else}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesAppKit, Api.Cocoa.DefinedClassesFoundation, Api.Cocoa.DefinedClassesOSAKit, Api.Cocoa.AppKit, Api.Cocoa.Foundation, System.CTypes, MacOSAll;
	{$else}
