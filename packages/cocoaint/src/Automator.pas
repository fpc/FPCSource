...
{$ifdef COCOAALL}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesAppKit, Api.Cocoa.DefinedClassesAutomator, Api.Cocoa.OSAKit, System.CTypes, Api.Cocoa.CocoaAll, MacOsApi.MacOSAll;
	{$else}
...
{$else}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesAppKit, Api.Cocoa.DefinedClassesAutomator, Api.Cocoa.AppKit, Api.Cocoa.OSAKit, Api.Cocoa.Foundation, System.CTypes, MacOSAll;
	{$else}
