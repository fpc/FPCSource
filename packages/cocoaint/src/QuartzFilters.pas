...
{$ifdef COCOAALL}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesAppKit, Api.Cocoa.DefinedClassesFoundation, Api.Cocoa.DefinedClassesQuartzFilters, System.CTypes, Api.Cocoa.CocoaAll, MacOsApi.MacOSAll;
	{$else}
...
{$else}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesAppKit, Api.Cocoa.DefinedClassesFoundation, Api.Cocoa.DefinedClassesQuartzFilters, Api.Cocoa.AppKit, Api.Cocoa.Foundation, System.CTypes, MacOSAll;
	{$else}
