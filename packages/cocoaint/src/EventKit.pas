...
{$ifdef CocoaAll}
	{$ifdef MacOSAll}
	  Api.Cocoa.DefinedClassesFoundation, Api.Cocoa.DefinedClassesEventKit, Api.Cocoa.CoreLocation, Api.Cocoa.CocoaAll, System.CTypes, MacOsApi.MacOSAll;
	{$else}
...
{$else}
	{$ifdef MacOSAll}
	  Api.Cocoa.DefinedClassesFoundation, Api.Cocoa.DefinedClassesEventKit, Api.Cocoa.Foundation, Api.Cocoa.CoreLocation, System.CTypes, MacOSAll;
	{$else}
