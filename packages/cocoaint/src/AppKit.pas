...
{$ifdef COCOAALL}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesAppKit, System.CTypes, Api.Cocoa.CocoaAll, MacOsApi.MacOSAll;
	{$else}
...
{$else}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesAppKit, Api.Cocoa.CoreData, Api.Cocoa.QuartzCore, Api.Cocoa.Foundation, System.CTypes, MacOSAll;
	{$else}
