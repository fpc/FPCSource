...
{$ifdef COCOAALL}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesFoundation, Api.Cocoa.DefinedClassesCoreImage, Api.Cocoa.CoreVideo, System.CTypes, Api.Cocoa.CocoaAll, MacOsApi.MacOSAll;
	{$else}
...
{$else}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesFoundation, Api.Cocoa.DefinedClassesCoreImage, Api.Cocoa.Foundation, Api.Cocoa.CoreVideo, System.CTypes, MacOSAll;
	{$else}
