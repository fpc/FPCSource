...
{$ifdef COCOAALL}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesFoundation, Api.Cocoa.DefinedClassesPDFKit, System.CTypes, Api.Cocoa.CocoaAll, MacOsApi.MacOSAll;
	{$else}
...
{$else}
	{$ifdef MACOSALL}
	  Api.Cocoa.DefinedClassesFoundation, Api.Cocoa.DefinedClassesPDFKit, Api.Cocoa.Foundation, Api.Cocoa.AppKit, System.CTypes, MacOSAll;
	{$else}
