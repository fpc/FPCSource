...
{$endif ALLPACKAGES}
    ...
    T:=P.Targets.AddUnit('fphttp2consts.pp');
    T.OSes:=SocketsOSes;
    T:=P.Targets.AddUnit('fphttp2frames.pp');
    T.OSes:=SocketsOSes;
    T.Dependencies.AddUnit('fphttp2consts');
    T:=P.Targets.AddUnit('fphttp2connection.pp');
    T.OSes:=SocketsOSes;
    T.Dependencies.AddUnit('fphttp2consts');
    T.Dependencies.AddUnit('fphttp2frames');
    T.Dependencies.AddUnit('uhpack');
    T:=P.Targets.AddUnit('fphttp2request.pp');
    T.OSes:=SocketsOSes;
    T.Dependencies.AddUnit('fphttp2consts');
    T.Dependencies.AddUnit('fphttp2frames');
    T.Dependencies.AddUnit('fphttp2connection');
    T.Dependencies.AddUnit('uhpack');
    T.Dependencies.AddUnit('httpdefs');
    T.Dependencies.AddUnit('httpprotocol');
    T.Dependencies.AddUnit('fphttpserver');
    T:=P.Targets.AddUnit('fphttp2server.pp');
    T.OSes:=SocketsOSes;
    T.Dependencies.AddUnit('fphttp2consts');
    T.Dependencies.AddUnit('fphttp2frames');
    T.Dependencies.AddUnit('fphttp2connection');
    T.Dependencies.AddUnit('fphttp2request');
    T.Dependencies.AddUnit('uhpack');
    T.Dependencies.AddUnit('httpdefs');
    T.Dependencies.AddUnit('httpprotocol');
    T.Dependencies.AddUnit('fphttpserver');
