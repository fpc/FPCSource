...
//
  ...
  UCHAR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.UCHAR {$ELSE} Byte {$ENDIF};
  {$EXTERNALSYM UCHAR}
  USHORT = Word;
  {$EXTERNALSYM USHORT}
  ULONG = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.ULONG {$ELSE} Cardinal {$ENDIF};
  {$EXTERNALSYM ULONG}
  UQUAD = QUAD;
  {$EXTERNALSYM UQUAD}
...
type
  LONGLONG = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LONGLONG {$ELSE} Int64 {$ENDIF};
...
type
  ...
  BOOL = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.BOOL {$ELSE} LongBool {$ENDIF};
  {$EXTERNALSYM BOOL}

  DWORD = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.DWORD {$ELSE} Longword {$ENDIF};
  {$EXTERNALSYM DWORD}
...
//
  ...
  SHORT = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.SHORT {$ELSE} Smallint {$ENDIF};
  {$EXTERNALSYM SHORT}
  LONG = Longint;
  {$EXTERNALSYM LONG}
...
//
  ...
  WCHAR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.WCHAR {$ELSE} WideChar {$ENDIF};
  {$EXTERNALSYM WCHAR}

  PWCHAR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PWChar {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM PWCHAR}
  LPWCH = ^WCHAR;
  {$EXTERNALSYM LPWCH}
  PWCH = ^WCHAR;
  ...
  NWPSTR = ^WCHAR;
  {$EXTERNALSYM NWPSTR}
  LPWSTR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LPWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM LPWSTR}
  LPCWSTR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LPCWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM LPCWSTR}
  PWSTR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LPWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM PWSTR}
  LPUWSTR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LPWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM LPUWSTR}
  PUWSTR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LPWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM PUWSTR}
  LPCUWSTR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LPWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM LPCUWSTR}
  PCUWSTR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LPWSTR {$ELSE} PWideChar {$ENDIF};
  {$EXTERNALSYM PCUWSTR}
...
//
  ...
  NPSTR = ^AnsiChar;
  {$EXTERNALSYM NPSTR}
  LPSTR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LPSTR {$ELSE} PAnsiChar {$ENDIF};
  {$EXTERNALSYM LPSTR}
  PSTR = PAnsiChar;
  {$EXTERNALSYM PSTR}
  LPCSTR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LPCSTR {$ELSE} PAnsiChar {$ENDIF};
  {$EXTERNALSYM LPCSTR}
  PCSTR = PAnsiChar;
  {$EXTERNALSYM PCSTR}
...
{$IFDEF UNICODE}
  ...
  PTSTR = LPWSTR;
  {$EXTERNALSYM PTSTR}
  LPTSTR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LPWSTR {$ELSE} LPWSTR {$ENDIF};
  {$EXTERNALSYM LPTSTR}
  PCTSTR = LPTSTR;
  {$EXTERNALSYM PCTSTR}
  LPCTSTR = LPTSTR;
...
//
  ...
  PUCHAR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PUCHAR {$ELSE} ^Byte {$ENDIF};
  {$EXTERNALSYM PUCHAR}
  PUSHORT = ^USHORT;
  {$EXTERNALSYM PUSHORT}
  PULONG = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PULONG {$ELSE} ^ULONG {$ENDIF};
  {$EXTERNALSYM PULONG}
  PUQUAD = ^UQUAD;
  {$EXTERNALSYM PUQUAD}
...
//
  ...
  HANDLE = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.THandle {$ELSE} Longword {$ENDIF};
  {$EXTERNALSYM HANDLE}
  PHANDLE = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PHandle {$ELSE} ^HANDLE {$ENDIF};
  {$EXTERNALSYM PHANDLE}
  THandle = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.THandle {$ELSE} HANDLE {$ENDIF};
...
//
  ...
  LCID = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LCID {$ELSE} DWORD {$ENDIF};
  {$EXTERNALSYM LCID}
  PLCID = ^LCID;
  {$EXTERNALSYM PLCID}
  LANGID = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LANGID {$ELSE} Word {$ENDIF};
  {$EXTERNALSYM LANGID}
...
type
  ...
  {$IFDEF USE_DELPHI_TYPES}
  _LARGE_INTEGER = {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows._LARGE_INTEGER;
  LARGE_INTEGER = {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LARGE_INTEGER;
  TLargeInteger = {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.TLargeInteger;
  {$ELSE}
  ...
  {$IFDEF USE_DELPHI_TYPES}
  ULARGE_INTEGER = {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.ULARGE_INTEGER;
  TULargeInteger = {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.TULargeInteger;
  PULargeInteger = {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PULargeInteger;
  {$ELSE}
...
type
  ...
  {$IFDEF USE_DELPHI_TYPES}
  _LIST_ENTRY = {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows._LIST_ENTRY;
  LIST_ENTRY = {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LIST_ENTRY;
  TListEntry = {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.TListEntry;
  PListEntry = {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PListEntry;
  {$ELSE}
  _LIST_ENTRY = record
    Flink: PLIST_ENTRY;
    Blink: PLIST_ENTRY;
...
//unsigned short      WORD;
  ...
  PFLOAT = ^FLOAT;
  {$EXTERNALSYM PFLOAT}
  PBOOL = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PBOOL {$ELSE} ^BOOL {$ENDIF};
  {$EXTERNALSYM PBOOL}
  LPBOOL = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PBOOL {$ELSE} ^BOOL {$ENDIF};
  {$EXTERNALSYM LPBOOL}
  PBYTE = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PBYTE {$ELSE} ^Byte {$ENDIF};
  {$EXTERNALSYM PBYTE}
  LPBYTE = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PBYTE {$ELSE} ^Byte {$ENDIF};
  {$EXTERNALSYM LPBYTE}
  PINT = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PINT {$ELSE} ^INT {$ENDIF};
  {$EXTERNALSYM PINT}
  PUINT = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PUINT {$ELSE} ^UINT {$ENDIF};
  {$EXTERNALSYM PUINT}
  LPUINT = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PUINT {$ELSE} ^UINT {$ENDIF};
  {$EXTERNALSYM LPUINT}
  LPINT = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PINT {$ELSE} ^INT {$ENDIF};
  {$EXTERNALSYM LPINT}
  PWORD = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PWORD {$ELSE} ^WORD {$ENDIF};
  {$EXTERNALSYM PWORD}
  LPWORD = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PWORD {$ELSE} ^WORD {$ENDIF};
  {$EXTERNALSYM LPWORD}
  LPLONG = ^LONG;
  {$EXTERNALSYM LPLONG}
  PDWORD = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PDWORD {$ELSE} ^DWORD {$ENDIF};
  {$EXTERNALSYM PDWORD}
  LPDWORD = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LPDWORD {$ELSE} ^DWORD {$ENDIF};
  {$EXTERNALSYM LPDWORD}
  LPVOID = Pointer;
  {$EXTERNALSYM LPVOID}
  LPCVOID = Pointer;
  ...
  INT = Integer;
  {$EXTERNALSYM INT}
  UINT = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.UINT {$ELSE} Longword {$ENDIF};
  {$EXTERNALSYM UINT}

// Types use for passing & returning polymorphic values

  WPARAM = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.WPARAM {$ELSE} UINT_PTR {$ENDIF};
  {$EXTERNALSYM WPARAM}
  LPARAM = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LPARAM {$ELSE} LONG_PTR {$ENDIF};
  {$EXTERNALSYM LPARAM}
  LRESULT = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.LRESULT {$ELSE} LONG_PTR {$ENDIF};
  {$EXTERNALSYM LRESULT}
...
type
  HWND = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HWND {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HWND}
  LPHWND = ^HWND;
  {$EXTERNALSYM LPHWND}
  HHOOK = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HHOOK {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HHOOK}
  LPHHOOK = ^HHOOK;
  {$EXTERNALSYM LPHHOOK}
  HEVENT = HANDLE;
  ...
  ATOM = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.ATOM {$ELSE} WORD {$ENDIF};
  {$EXTERNALSYM ATOM}
  ...
  HGLOBAL = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HGLOBAL {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HGLOBAL}
  HLOCAL = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HLOCAL {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HLOCAL}
  //GLOBALHANDLE = HANDLE;
  ...
  FARPROC = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.FARPROC {$ELSE} function: Integer; stdcall {$ENDIF};
  {$EXTERNALSYM FARPROC}
  ...
  HGDIOBJ = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HGDIOBJ {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HGDIOBJ}

  HKEY = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HKEY {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HKEY}
  PHKEY = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PHKEY {$ELSE} ^HKEY {$ENDIF};
  {$EXTERNALSYM PHKEY}

  HACCEL = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HACCEL {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HACCEL}

  HBITMAP = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HBITMAP {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HBITMAP}
  HBRUSH = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HBRUSH {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HBRUSH}

  HCOLORSPACE = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HCOLORSPACE {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HCOLORSPACE}

  HDC = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HDC {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HDC}
  HGLRC = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HGLRC {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HGLRC}
  HDESK = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HDESK {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HDESK}
  HENHMETAFILE = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HENHMETAFILE {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HENHMETAFILE}
  HFONT = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HFONT {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HFONT}
  HICON = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HICON {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HICON}
  HMENU = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HMENU {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HMENU}
  HMETAFILE = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HMETAFILE {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HMETAFILE}

  // (rom) HINSTANCE collides with Delphi HInstance global variable
  HINST = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HINST {$ELSE} HANDLE {$ENDIF};

  HMODULE = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HMODULE {$ELSE} HINST {$ENDIF};
  {$EXTERNALSYM HMODULE}
  HPALETTE = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HPALETTE {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HPALETTE}
  HPEN = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HPEN {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HPEN}
  HRGN = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HRGN {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HRGN}
  HRSRC = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HRSRC {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HRSRC}
  HSTR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HSTR {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HSTR}
  HTASK = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HTASK {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HTASK}
  HWINSTA = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HWINSTA {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HWINSTA}
  HKL = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HKL {$ELSE} HANDLE {$ENDIF};
  {$EXTERNALSYM HKL}
  ...
  HFILE = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HFILE {$ELSE} Longword {$ENDIF};
  {$EXTERNALSYM HFILE}
  HCURSOR = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.HCURSOR {$ELSE} HICON {$ENDIF};
  {$EXTERNALSYM HCURSOR}

  COLORREF = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.COLORREF {$ELSE} DWORD {$ENDIF};
...
type
  ...
  {$EXTERNALSYM tagRECT}
  RECT = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.TRect {$ELSE} tagRECT {$ENDIF};
  {$EXTERNALSYM RECT}
  NPRECT = ^RECT;
  {$EXTERNALSYM NPRECT}
  LPCRECT = ^RECT;
  {$EXTERNALSYM LPCRECT}
  TRect = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.TRect {$ELSE} RECT {$ENDIF};
  PRect = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PRect {$ELSE} LPRECT {$ENDIF};
  ...
  POINT = tagPOINT;
  {$EXTERNALSYM tagPOINT}
  TPoint = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.TPoint {$ELSE} POINT {$ENDIF};
  PPoint = {$IFDEF USE_DELPHI_TYPES} {$IFDEF FPC_DOTTEDUNITS}WinApi.{$ENDIF}Windows.PPoint {$ELSE} LPPOINT {$ENDIF};
