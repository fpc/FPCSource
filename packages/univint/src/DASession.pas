...
uses MacOsApi.MacTypes,MacOsApi.CFBase,MacOsApi.CFRunLoop,MacOsApi.CFString;
...
function DASessionGetTypeID: CFTypeID; external name '_DASessionGetTypeID';
...
function DASessionCreate( allocator: CFAllocatorRef ): DASessionRef; external name '_DASessionCreate';
...
procedure DASessionScheduleWithRunLoop( session: DASessionRef; runLoop: CFRunLoopRef; runLoopMode: CFStringRef ); external name '_DASessionScheduleWithRunLoop';
...
procedure DASessionUnscheduleFromRunLoop( session: DASessionRef; runLoop: CFRunLoopRef; runLoopMode: CFStringRef ); external name '_DASessionUnscheduleFromRunLoop';
...
function DAApprovalSessionGetTypeID: CFTypeID; external name '_DAApprovalSessionGetTypeID';
...
function DAApprovalSessionCreate( allocator: CFAllocatorRef ): DAApprovalSessionRef; external name '_DAApprovalSessionCreate';
...
procedure DAApprovalSessionScheduleWithRunLoop( session: DAApprovalSessionRef; runLoop: CFRunLoopRef; runLoopMode: CFStringRef ); external name '_DAApprovalSessionScheduleWithRunLoop';
...
procedure DAApprovalSessionUnscheduleFromRunLoop( session: DAApprovalSessionRef; runLoop: CFRunLoopRef; runLoopMode: CFStringRef ); external name '_DAApprovalSessionUnscheduleFromRunLoop';
