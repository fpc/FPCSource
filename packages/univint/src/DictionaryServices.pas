...
function DCSGetTermRangeInString( dictionary: DCSDictionaryRef; textString: CFStringRef; offset: CFIndex ): CFRange; external name '_DCSGetTermRangeInString';
...
function DCSCopyTextDefinition( dictionary: DCSDictionaryRef; textString: CFStringRef; range: CFRange ): CFStringRef; external name '_DCSCopyTextDefinition';
(* AVAILABLE_MAC_OS_X_VERSION_10_5_AND_LATER *)
